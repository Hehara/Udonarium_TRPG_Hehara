...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MetalHeadExtream_initialize_1, TMP_MetalHeadExtream_gameName_2, TMP_MetalHeadExtream_gameType_3, TMP_MetalHeadExtream_getHelpMessage_4, TMP_MetalHeadExtream_rollDiceCommand_6, TMP_MetalHeadExtream_checkRoll_7, TMP_MetalHeadExtream_get_roll_parameter_8, TMP_MetalHeadExtream_getRollResultTextAndSuccesValue_9, TMP_MetalHeadExtream_getFormulaText_10, TMP_MetalHeadExtream_get_hit_table_11, TMP_MetalHeadExtream_get_SUV_table_13, TMP_MetalHeadExtream_get_damageEffect_table_15, TMP_MetalHeadExtream_get_critical_table_16, TMP_MetalHeadExtream_get_accident_table_17, TMP_MetalHeadExtream_get_mechanicAccident_table_18, TMP_MetalHeadExtream_get_strategyEvent_chart_19, TMP_MetalHeadExtream_get_NPCAttack_chart_20, TMP_MetalHeadExtream_get_loserDestiny_chart_21, TMP_MetalHeadExtream_get_randomEncounter_table_22, TMP_MetalHeadExtream_get_MetalHeadExtream_1d10_table_result_23, TMP_MetalHeadExtream_get_MetalHeadExtream_1d100_table_result_24, TMP_MetalHeadExtream_get_MetalHeadExtream_1dX_table_result_25, TMP_MetalHeadExtream_get_roc_dice_26, TMP_MetalHeadExtream_get_value_28;
    ...
    Opal.defn(self, '$initialize', TMP_MetalHeadExtream_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_MetalHeadExtream_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_MetalHeadExtream_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      return $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_MetalHeadExtream_initialize_1, false), $zuper, $iter)
    }, TMP_MetalHeadExtream_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_MetalHeadExtream_gameName_2 = function $$gameName() {
      var self = this;

      return "メタルヘッドエクストリーム"
    }, TMP_MetalHeadExtream_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_MetalHeadExtream_gameType_3 = function $$gameType() {
      var self = this;

      return "MetalHeadExtream"
    }, TMP_MetalHeadExtream_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_MetalHeadExtream_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;

      return "" + "◆判定：ARn or SRn[*/a][@b][Ac][Ld][!M]　　[]内省略可。\n" + "「n」で判定値、「*/a」でロール修正を指定。複数回指定可。\n" + "「@b」でアクシデント値、省略時は「96」。\n" + "「Ac」で高度なロール。「2、4、8」のみ指定可能。\n" + "「Ld」でラックポイント、「!M」でパンドラ《ミューズ》。\n" + "\n" + "【書式例】\n" + "AR84/2@99!M → 判定値84のAR1/2。アクシデント値99、パンドラ《ミューズ》。\n" + "SR40*2A2L1@99 → 判定値80のSR、高度なロール2倍、ラック1点。\n" + "\n" + "◆命中部位表：(命中部位)HIT[n]　　以降、ROC時は[n]を指定。\n" + "HU：人間　　BK：バイク　　WA：ワゴン　　SC：シェルキャリア　　BG：バギー\n" + "IN：インセクター　　PT：ポケットタンク　　HT：ホバータンク　　TA：戦車\n" + "AC：装甲車　　HE：ヘリ　　TR：トレーラー　　VT：VTOL　　BO：ボート\n" + "CS：通常、格闘型コンバットシェル　　TH：可変、重コンバットシェル\n" + "AM：オートモビル　　GD：ガンドック　　HC：ホバークラフト\n" + "BI：自転車　　BT：バトルトレーラー　　AI：エアクラフト\n" + "◆戦闘結果表：SUV(A～Z)n　　【書式例】SUVM100\n" + "◆損傷効果表：(命中部位)DMG(損傷種別)　　【書式例】TDMGH\n" + "H：頭部　　T：胴部　　A：腕部　　L：脚部　　M：心理　　E：電子\n" + "B：メカニック本体　　P：パワープラント　　D：ドライブ\n" + "(損傷種別)　L：LW　　M：MW　　H：HW　　O：MO\n" + "◆クリティカル表：CRT[n]\n" + "◆アクシデント表：(種別)AC[n]\n" + "G：格闘　　S：射撃、投擲　　M：心理　　E：電子\n" + "◆メカニック事故表：(場所)MA[n][+m]　　「+m」で修正を指定。\n" + "A：空中　　S：水上、水中　　L：地上\n" + "\n" + "【マスコンバット】\n" + "ストラテジーイベントチャート：SEC\n" + "NPC攻撃処理チャート：NAC　　敗者運命チャート：LDC\n" + "\n" + "【各種表】\n" + "荒野ランダムエンカウント表：WENC[n]\n"
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_MetalHeadExtream_rollDiceCommand_6 = function $$rollDiceCommand(command) {
      ...
      $send(params, 'each', [], (TMP_5 = function(marker, value){var self = TMP_5.$$s || this, $b, $c;
if (marker == null) marker = nil;if (value == null) value = nil;
    ...
    Opal.defn(self, '$checkRoll', TMP_MetalHeadExtream_checkRoll_7 = function $$checkRoll(rollText, target, modify, accidentValue, advancedRoll, luckPoint, isMuse) {
      ...
      return result;
    }, TMP_MetalHeadExtream_checkRoll_7.$$arity = 7);
    
    Opal.defn(self, '$get_roll_parameter', TMP_MetalHeadExtream_get_roll_parameter_8 = function $$get_roll_parameter(accident, advanced, luck, marker, value) {
    ...
    }, TMP_MetalHeadExtream_get_roll_parameter_8.$$arity = 5);
    
    Opal.defn(self, '$getRollResultTextAndSuccesValue', TMP_MetalHeadExtream_getRollResultTextAndSuccesValue_9 = function $$getRollResultTextAndSuccesValue(dice, advancedRoll, rollTarget, accidentValue, isMuse) {
      ...
      return [resultText, successValue];
    }, TMP_MetalHeadExtream_getRollResultTextAndSuccesValue_9.$$arity = 5);
    
    Opal.defn(self, '$getFormulaText', TMP_MetalHeadExtream_getFormulaText_10 = function $$getFormulaText(target, modify, advancedRoll, luckPoint) {
      ...
      if (formulaText['$=='](target.$to_s())) {
        return ""};
      return "" + "[" + (formulaText) + "]";
    }, TMP_MetalHeadExtream_getFormulaText_10.$$arity = 4);
    
    Opal.defn(self, '$get_hit_table', TMP_MetalHeadExtream_get_hit_table_11 = function $$get_hit_table(hitPart, roc) {
    ...
    }, TMP_MetalHeadExtream_get_hit_table_11.$$arity = 2);
    
    Opal.defn(self, '$get_SUV_table', TMP_MetalHeadExtream_get_SUV_table_13 = function $$get_SUV_table(armorGrade, damage) {
      var TMP_12, self = this, name = nil, table = nil, armorIndex = nil, damageInfo = nil, woundRanks = nil, woundText = nil;
      ...
      woundText = "";
      (function(){var $brk = Opal.new_brk(); try {return $send(damageInfo, 'each_with_index', [], (TMP_12 = function(rate, index){var self = TMP_12.$$s || this;
if (rate == null) rate = nil;if (index == null) index = nil;
      
        if ($truthy($rb_gt(rate, damage))) {
          
          Opal.brk(nil, $brk)};
        return (woundText = woundRanks['$[]'](index));}, TMP_12.$$s = self, TMP_12.$$brk = $brk, TMP_12.$$arity = 2, TMP_12))
      } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
      return "" + (name) + "(" + (armorGrade) + ")：" + (damage) + " ＞ " + (woundText);
    }, TMP_MetalHeadExtream_get_SUV_table_13.$$arity = 2);
    
    Opal.defn(self, '$get_damageEffect_table', TMP_MetalHeadExtream_get_damageEffect_table_15 = function $$get_damageEffect_table(hitPart, damageStage) {
      var TMP_14, self = this, damageInfos = nil, index = nil, damageIndex = nil, damageText = nil, $case = nil, name = nil, table = nil, text = nil;
...
if (type == null) type = nil;
    ...
    }, TMP_MetalHeadExtream_get_damageEffect_table_15.$$arity = 2);
    
    Opal.defn(self, '$get_critical_table', TMP_MetalHeadExtream_get_critical_table_16 = function $$get_critical_table(roc) {
      ...
      return self.$get_MetalHeadExtream_1d10_table_result(name, table, roc);
    }, TMP_MetalHeadExtream_get_critical_table_16.$$arity = 1);
    
    Opal.defn(self, '$get_accident_table', TMP_MetalHeadExtream_get_accident_table_17 = function $$get_accident_table(damageType, roc) {
      var self = this, $case = nil, name = nil, table = nil;
      ...
      return self.$get_MetalHeadExtream_1d10_table_result(name, table, roc);
    }, TMP_MetalHeadExtream_get_accident_table_17.$$arity = 2);
    
    Opal.defn(self, '$get_mechanicAccident_table', TMP_MetalHeadExtream_get_mechanicAccident_table_18 = function $$get_mechanicAccident_table(locationType, roc, correction) {
      ...
      return text;
    }, TMP_MetalHeadExtream_get_mechanicAccident_table_18.$$arity = 3);
    
    Opal.defn(self, '$get_strategyEvent_chart', TMP_MetalHeadExtream_get_strategyEvent_chart_19 = function $$get_strategyEvent_chart() {
      var self = this, name = nil, table = nil;
    ...
    Opal.defn(self, '$get_NPCAttack_chart', TMP_MetalHeadExtream_get_NPCAttack_chart_20 = function $$get_NPCAttack_chart() {
      var self = this, name = nil, table = nil;
    ...
    }, TMP_MetalHeadExtream_get_NPCAttack_chart_20.$$arity = 0);
    
    Opal.defn(self, '$get_loserDestiny_chart', TMP_MetalHeadExtream_get_loserDestiny_chart_21 = function $$get_loserDestiny_chart() {
      var self = this, name = nil, table = nil;
      ...
      return self.$get_MetalHeadExtream_1d10_table_result(name, table, 0);
    }, TMP_MetalHeadExtream_get_loserDestiny_chart_21.$$arity = 0);
    
    Opal.defn(self, '$get_randomEncounter_table', TMP_MetalHeadExtream_get_randomEncounter_table_22 = function $$get_randomEncounter_table(locationType, roc) {
      var self = this, $case = nil, name = nil, table = nil;
    ...
    }, TMP_MetalHeadExtream_get_randomEncounter_table_22.$$arity = 2);
    
    Opal.defn(self, '$get_MetalHeadExtream_1d10_table_result', TMP_MetalHeadExtream_get_MetalHeadExtream_1d10_table_result_23 = function $$get_MetalHeadExtream_1d10_table_result(name, table, roc) {
      var self = this;

      return self.$get_MetalHeadExtream_1dX_table_result(name, table, roc, 10)
    }, TMP_MetalHeadExtream_get_MetalHeadExtream_1d10_table_result_23.$$arity = 3);
    
    Opal.defn(self, '$get_MetalHeadExtream_1d100_table_result', TMP_MetalHeadExtream_get_MetalHeadExtream_1d100_table_result_24 = function $$get_MetalHeadExtream_1d100_table_result(name, table, roc) {
      var self = this;

      return self.$get_MetalHeadExtream_1dX_table_result(name, table, roc, 100)
    }, TMP_MetalHeadExtream_get_MetalHeadExtream_1d100_table_result_24.$$arity = 3);
    
    Opal.defn(self, '$get_MetalHeadExtream_1dX_table_result', TMP_MetalHeadExtream_get_MetalHeadExtream_1dX_table_result_25 = function $$get_MetalHeadExtream_1dX_table_result(name, table, roc, diceMax) {
    ...
    }, TMP_MetalHeadExtream_get_MetalHeadExtream_1dX_table_result_25.$$arity = 4);
    
    Opal.defn(self, '$get_roc_dice', TMP_MetalHeadExtream_get_roc_dice_26 = function $$get_roc_dice(roc, diceMax) {
...
if (i == null) i = nil;
      ...
      return result;
    }, TMP_MetalHeadExtream_get_value_28.$$arity = 2), nil) && 'get_value';
