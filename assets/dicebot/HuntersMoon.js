...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_HuntersMoon_initialize_1, TMP_HuntersMoon_gameName_2, TMP_HuntersMoon_gameType_3, TMP_HuntersMoon_getHelpMessage_4, TMP_HuntersMoon_check_2D6_5, TMP_HuntersMoon_rollDiceCommand_6, TMP_HuntersMoon_hm_city_location_table_7, TMP_HuntersMoon_hm_small_location_table_8, TMP_HuntersMoon_hm_hot_location_table_9, TMP_HuntersMoon_hm_freezing_location_table_10, TMP_HuntersMoon_hm_encount_table_11, TMP_HuntersMoon_hm_monobeast_action_table_12, TMP_HuntersMoon_hm_hit_location_table_13, TMP_HuntersMoon_getStrangeAbilityTable1_14, TMP_HuntersMoon_get_strange_ability_table_result_16, TMP_HuntersMoon_get_strange_ability_table_1_17, TMP_HuntersMoon_get_strange_ability_table_2_18, TMP_HuntersMoon_hm_social_skill_table_19, TMP_HuntersMoon_hm_head_skill_table_20, TMP_HuntersMoon_hm_arm_skill_table_21, TMP_HuntersMoon_hm_trunk_skill_table_22, TMP_HuntersMoon_hm_leg_skill_table_23, TMP_HuntersMoon_hm_environmental_skill_table_24, $a;

    
    
    Opal.defn(self, '$initialize', TMP_HuntersMoon_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_HuntersMoon_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_HuntersMoon_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_HuntersMoon_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      self.d66Type = 2;
      return (self.fractionType = "roundUp");
    }, TMP_HuntersMoon_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_HuntersMoon_gameName_2 = function $$gameName() {
      var self = this;

      return "ハンターズムーン"
    }, TMP_HuntersMoon_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_HuntersMoon_gameType_3 = function $$gameType() {
      var self = this;

      return "HuntersMoon"
    }, TMP_HuntersMoon_gameType_3.$$arity = 0);
    ...
    }, TMP_HuntersMoon_check_2D6_5.$$arity = 8);
    
    Opal.defn(self, '$rollDiceCommand', TMP_HuntersMoon_rollDiceCommand_6 = function $$rollDiceCommand(command) {
      ...
      return output;
    }, TMP_HuntersMoon_rollDiceCommand_6.$$arity = 1);
    
    Opal.defn(self, '$hm_city_location_table', TMP_HuntersMoon_hm_city_location_table_7 = function $$hm_city_location_table() {
    ...
    Opal.defn(self, '$hm_small_location_table', TMP_HuntersMoon_hm_small_location_table_8 = function $$hm_small_location_table() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$hm_hot_location_table', TMP_HuntersMoon_hm_hot_location_table_9 = function $$hm_hot_location_table() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$hm_freezing_location_table', TMP_HuntersMoon_hm_freezing_location_table_10 = function $$hm_freezing_location_table() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$hm_encount_table', TMP_HuntersMoon_hm_encount_table_11 = function $$hm_encount_table() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_1d6(table);
    }, TMP_HuntersMoon_hm_encount_table_11.$$arity = 0);
    
    Opal.defn(self, '$hm_monobeast_action_table', TMP_HuntersMoon_hm_monobeast_action_table_12 = function $$hm_monobeast_action_table() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_1d6(table);
    }, TMP_HuntersMoon_hm_monobeast_action_table_12.$$arity = 0);
    
    Opal.defn(self, '$hm_hit_location_table', TMP_HuntersMoon_hm_hit_location_table_13 = function $$hm_hit_location_table() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$getStrangeAbilityTable1', TMP_HuntersMoon_getStrangeAbilityTable1_14 = function $$getStrangeAbilityTable1() {
      var self = this;

      return nil
    }, TMP_HuntersMoon_getStrangeAbilityTable1_14.$$arity = 0);
    
    Opal.defn(self, '$get_strange_ability_table_result', TMP_HuntersMoon_get_strange_ability_table_result_16 = function $$get_strange_ability_table_result(count, isType2) {
      var TMP_15, self = this, output = nil, dice = nil, table1 = nil, table2 = nil;
      ...
      $send(count, 'times', [], (TMP_15 = function(i){var self = TMP_15.$$s || this, $a, $b, table = nil, number = nil, index = nil, ability = nil, indexText = nil;
if (i == null) i = nil;
      ...
      if ($truthy(output['$empty?']())) {
        return ["1", dice]};
      return [output, dice];
    }, TMP_HuntersMoon_get_strange_ability_table_result_16.$$arity = 2);
    
    Opal.defn(self, '$get_strange_ability_table_1', TMP_HuntersMoon_get_strange_ability_table_1_17 = function $$get_strange_ability_table_1() {
      var self = this, table = nil;
      ...
      return table;
    }, TMP_HuntersMoon_get_strange_ability_table_1_17.$$arity = 0);
    
    Opal.defn(self, '$get_strange_ability_table_2', TMP_HuntersMoon_get_strange_ability_table_2_18 = function $$get_strange_ability_table_2() {
      var self = this, table = nil;
