...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$=~', '$prefixesPattern', '$class', '$last_match', '$upcase', '$getCommandResult', '$!=', '$==', '$-', '$<=', '$>=', '$===', '$get_table_by_nD6', '$to_i', '$roll', '$+', '$>', '$[]', '$<', '$getTrapTable', '$nil?', '$floor', '$/', '$getTresureTable', '$get_table_by_1d6', '$!', '$getRandomEvent', '$get_table_by_d66', '$getLotResult', '$lambda', '$to_s', '$normal2', '$normal3', '$normal4', '$normal5', '$premium5', '$premium2', '$premium3', '$premium4', '$premium6', '$premium1', '$normal1', '$getRandomDiff', '$get_table_by_number']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$initialize', TMP_GurpsFW_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_GurpsFW_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_GurpsFW_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_GurpsFW_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      return (self.d66Type = 1);
    }, TMP_GurpsFW_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_GurpsFW_gameName_2 = function $$gameName() {
      var self = this;

      return "ガープスフィルトウィズ"
    }, TMP_GurpsFW_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_GurpsFW_gameType_3 = function $$gameType() {
      var self = this;

      return "GurpsFW"
    }, TMP_GurpsFW_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_GurpsFW_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;
    ...
    Opal.defn(self, '$dice_command', TMP_GurpsFW_dice_command_5 = function $$dice_command(string, name) {
      ...
      command = Opal.const_get_relative($nesting, 'Regexp').$last_match(3).$upcase();
      output_msg = self.$getCommandResult(command, name);
      if ($truthy(secretMarker)) {
        if ($truthy(output_msg['$!=']("1"))) {
          secret_flg = true}};
      return [output_msg, secret_flg];
    }, TMP_GurpsFW_dice_command_5.$$arity = 2);
    
    Opal.defn(self, '$check_nD6', TMP_GurpsFW_check_nD6_6 = function $$check_nD6(total_n, dice_n, signOfInequality, diff, dice_cnt, _dice_max, _n1, _n_max) {
      var $a, self = this, success = nil, crt_string = nil, fmb_string = nil, fail_string = nil;

      
      if ($truthy(($truthy($a = dice_cnt['$=='](3)) ? signOfInequality['$==']("<=") : $a))) {
    ...
    Opal.defn(self, '$getCommandResult', TMP_GurpsFW_getCommandResult_7 = function $$getCommandResult(string, nick_e) {
      ...
      tableName = "トラップリスト";
      diff = Opal.const_get_relative($nesting, 'Regexp').$last_match(1);
      ...
      tableName = "財宝テーブル";
      diff = Opal.const_get_relative($nesting, 'Regexp').$last_match(1);
      depth = Opal.const_get_relative($nesting, 'Regexp').$last_match(2).$to_i();
      ...
      if ($truthy(Opal.const_get_relative($nesting, 'Regexp').$last_match(4)['$nil?']())) {
        ...
        num = $rb_plus(num, Opal.const_get_relative($nesting, 'Regexp').$last_match(3).$to_i())
      };
      ...
      if ($truthy(Opal.const_get_relative($nesting, 'Regexp').$last_match(1)['$nil?']())) {
        ...
        mode = Opal.const_get_relative($nesting, 'Regexp').$last_match(1)
      };
      if ($truthy(Opal.const_get_relative($nesting, 'Regexp').$last_match(4)['$nil?']())) {
        } else {
    ...
    Opal.defn(self, '$getTresureTable', TMP_GurpsFW_getTresureTable_36 = function $$getTresureTable(num) {
      ...
      return table;
    }, TMP_GurpsFW_getTresureTable_36.$$arity = 1);
    
    Opal.defn(self, '$getTrapTable', TMP_GurpsFW_getTrapTable_37 = function $$getTrapTable(diff) {
      ...
      return [dif, table];
    }, TMP_GurpsFW_getTrapTable_37.$$arity = 1);
    
    Opal.defn(self, '$getRandomEvent', TMP_GurpsFW_getRandomEvent_38 = function $$getRandomEvent(dice1, dice2, diff) {
    ...
    }, TMP_GurpsFW_getRandomEvent_38.$$arity = 3);
    return (Opal.defn(self, '$getRandomDiff', TMP_GurpsFW_getRandomDiff_39 = function $$getRandomDiff(dice1, dice23, dif, index) {
    ...
    }, TMP_GurpsFW_getRandomDiff_39.$$arity = 4), nil) && 'getRandomDiff';
