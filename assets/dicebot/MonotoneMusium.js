...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MonotoneMusium_initialize_1, TMP_MonotoneMusium_gameName_2, TMP_MonotoneMusium_gameType_3, TMP_MonotoneMusium_getHelpMessage_4, TMP_MonotoneMusium_rollDiceCommand_5, TMP_MonotoneMusium_checkRoll_6, TMP_MonotoneMusium_rollTableCommand_7, TMP_MonotoneMusium_mm_emotion_table_8, TMP_MonotoneMusium_mm_emotion_table_ver2_9, TMP_MonotoneMusium_mm_omens_table_10, TMP_MonotoneMusium_mm_distortion_table_11, TMP_MonotoneMusium_mm_distortion_table_ver2_12, TMP_MonotoneMusium_mm_world_distortion_table_13, TMP_MonotoneMusium_mm_world_distortion_table_ver2_14, TMP_MonotoneMusium_mm_omens_table_ver2_15, TMP_MonotoneMusium_mm_distortion_table_outdoor_16, TMP_MonotoneMusium_mm_distortion_table_sea_17;

    def.sortType = nil;
    
    self.$setPrefixes(["2D6.*", "ET", "ET2", "OT", "DT", "DT2", "WDT", "WDT2", "OT2", "DTO", "DTS"]);
    
    Opal.defn(self, '$initialize', TMP_MonotoneMusium_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_MonotoneMusium_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_MonotoneMusium_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_MonotoneMusium_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.d66Type = 1;
      return (self.sortType = 1);
    }, TMP_MonotoneMusium_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_MonotoneMusium_gameName_2 = function $$gameName() {
      var self = this;

      return "モノトーン・ミュージアム"
    }, TMP_MonotoneMusium_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_MonotoneMusium_gameType_3 = function $$gameType() {
      var self = this;

      return "MonotoneMusium"
    }, TMP_MonotoneMusium_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_MonotoneMusium_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;
    ...
    }, TMP_MonotoneMusium_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_MonotoneMusium_rollDiceCommand_5 = function $$rollDiceCommand(command) {
    ...
    }, TMP_MonotoneMusium_rollDiceCommand_5.$$arity = 1);
    
    Opal.defn(self, '$checkRoll', TMP_MonotoneMusium_checkRoll_6 = function $$checkRoll(string) {
      ...
      return output;
    }, TMP_MonotoneMusium_checkRoll_6.$$arity = 1);
    
    Opal.defn(self, '$rollTableCommand', TMP_MonotoneMusium_rollTableCommand_7 = function $$rollTableCommand(command) {
      ...
      return output;
    }, TMP_MonotoneMusium_rollTableCommand_7.$$arity = 1);
    
    Opal.defn(self, '$mm_emotion_table', TMP_MonotoneMusium_mm_emotion_table_8 = function $$mm_emotion_table() {
    ...
    }, TMP_MonotoneMusium_mm_emotion_table_8.$$arity = 0);
    
    Opal.defn(self, '$mm_emotion_table_ver2', TMP_MonotoneMusium_mm_emotion_table_ver2_9 = function $$mm_emotion_table_ver2() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_mm_emotion_table_ver2_9.$$arity = 0);
    
    Opal.defn(self, '$mm_omens_table', TMP_MonotoneMusium_mm_omens_table_10 = function $$mm_omens_table() {
      var self = this, table = nil;
    ...
    }, TMP_MonotoneMusium_mm_omens_table_10.$$arity = 0);
    
    Opal.defn(self, '$mm_distortion_table', TMP_MonotoneMusium_mm_distortion_table_11 = function $$mm_distortion_table() {
      var self = this, table = nil;
    ...
    Opal.defn(self, '$mm_distortion_table_ver2', TMP_MonotoneMusium_mm_distortion_table_ver2_12 = function $$mm_distortion_table_ver2() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_mm_distortion_table_ver2_12.$$arity = 0);
    
    Opal.defn(self, '$mm_world_distortion_table', TMP_MonotoneMusium_mm_world_distortion_table_13 = function $$mm_world_distortion_table() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_2d6(table);
    }, TMP_MonotoneMusium_mm_world_distortion_table_13.$$arity = 0);
    
    Opal.defn(self, '$mm_world_distortion_table_ver2', TMP_MonotoneMusium_mm_world_distortion_table_ver2_14 = function $$mm_world_distortion_table_ver2() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_mm_world_distortion_table_ver2_14.$$arity = 0);
    
    Opal.defn(self, '$mm_omens_table_ver2', TMP_MonotoneMusium_mm_omens_table_ver2_15 = function $$mm_omens_table_ver2() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_mm_omens_table_ver2_15.$$arity = 0);
    
    Opal.defn(self, '$mm_distortion_table_outdoor', TMP_MonotoneMusium_mm_distortion_table_outdoor_16 = function $$mm_distortion_table_outdoor() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_mm_distortion_table_outdoor_16.$$arity = 0);
    return (Opal.defn(self, '$mm_distortion_table_sea', TMP_MonotoneMusium_mm_distortion_table_sea_17 = function $$mm_distortion_table_sea() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_mm_distortion_table_sea_17.$$arity = 0), nil) && 'mm_distortion_table_sea';
