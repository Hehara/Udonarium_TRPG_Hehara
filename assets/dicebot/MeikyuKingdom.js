...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$initialize', TMP_MeikyuKingdom_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_MeikyuKingdom_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_MeikyuKingdom_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_MeikyuKingdom_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 2);
    }, TMP_MeikyuKingdom_initialize_1.$$arity = 0);
    ...
    Opal.defn(self, '$dice_command_xRn', TMP_MeikyuKingdom_dice_command_xRn_8 = function $$dice_command_xRn(string, nick_e) {
      var self = this;
    ...
    Opal.defn(self, '$check_2D6', TMP_MeikyuKingdom_check_2D6_9 = function $$check_2D6(total_n, dice_n, signOfInequality, diff, _dice_cnt, _dice_max, _n1, _n_max) {
      ...
      result = self.$get2D6Result(total_n, dice_n, signOfInequality, diff);
      result = $rb_plus(result, self.$getKiryokuResult(total_n, dice_n, signOfInequality, diff));
      return result;
    }, TMP_MeikyuKingdom_check_2D6_9.$$arity = 8);
    
    Opal.defn(self, '$get2D6Result', TMP_MeikyuKingdom_get2D6Result_10 = function $$get2D6Result(total_n, dice_n, signOfInequality, diff) {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_get2D6Result_10.$$arity = 4);
    
    Opal.defn(self, '$get2D6ResultOnlySuccess', TMP_MeikyuKingdom_get2D6ResultOnlySuccess_11 = function $$get2D6ResultOnlySuccess(total_n, diff) {
      var self = this;
    ...
    Opal.defn(self, '$getKiryokuResult', TMP_MeikyuKingdom_getKiryokuResult_14 = function $$getKiryokuResult(total_n, _dice_n, _signOfInequality, diff) {
      ...
      self.$debug("getKiryokuResult diceList", diceList);
      dice6List = $send(diceList, 'find_all', [], (TMP_12 = function(i){var self = TMP_12.$$s || this;
if (i == null) i = nil;
      ...
      diceNone6List = $send(diceList, 'find_all', [], (TMP_13 = function(i){var self = TMP_13.$$s || this;
if (i == null) i = nil;
      return i['$!='](6)}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13));
      diceNone6List['$sort!']();
      self.$debug("diceNone6List", diceNone6List);
    ...
    }, TMP_MeikyuKingdom_getKiryokuResult_14.$$arity = 4);
    
    Opal.defn(self, '$mayokin_check', TMP_MeikyuKingdom_mayokin_check_16 = function $$mayokin_check(string, nick_e) {
      var $a, $b, TMP_15, self = this, output = nil, diceCount = nil, modifyText = nil, signOfInequality = nil, diff = nil, bonus = nil, dice_now = nil, dice_str = nil, total_n = nil, _ = nil, dice_num = nil, dice1 = nil, dice2 = nil;
      ...
      dice_num = $send(dice_str.$split(/,/), 'collect', [], (TMP_15 = function(i){var self = TMP_15.$$s || this;
if (i == null) i = nil;
      return i.$to_i()}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15));
      self.$debug("diceCount, dice_num", diceCount, dice_num);
      dice1 = 0;
      dice2 = 0;
      if ($truthy($rb_ge(diceCount, 2))) {
        dice1 = dice_num['$[]']($rb_minus(diceCount, 2))};
      if ($truthy($rb_ge(diceCount, 1))) {
        dice2 = dice_num['$[]']($rb_minus(diceCount, 1))};
      dice_now = $rb_plus(dice1, dice2);
      self.$debug("dice1, dice2, dice_now", dice1, dice2, dice_now);
      total_n = $rb_plus(dice_now, bonus);
      dice_str = "" + "[" + (dice_str) + "]";
      self.$setDiceText(dice_str);
...
if (_i == null) _i = nil;
    ...
    }, TMP_MeikyuKingdom_rollDiceCommand_18.$$arity = 1);
    
    Opal.defn(self, '$getCount', TMP_MeikyuKingdom_getCount_19 = function $$getCount(countText) {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_getCount_19.$$arity = 1);
    
    Opal.defn(self, '$mk_life_research_table', TMP_MeikyuKingdom_mk_life_research_table_20 = function $$mk_life_research_table() {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_mk_life_research_table_20.$$arity = 0);
    
    Opal.defn(self, '$mk_order_research_table', TMP_MeikyuKingdom_mk_order_research_table_21 = function $$mk_order_research_table() {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_mk_order_research_table_21.$$arity = 0);
    
    Opal.defn(self, '$mk_calture_research_table', TMP_MeikyuKingdom_mk_calture_research_table_22 = function $$mk_calture_research_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_army_research_table', TMP_MeikyuKingdom_mk_army_research_table_23 = function $$mk_army_research_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_talent_break_table', TMP_MeikyuKingdom_mk_talent_break_table_24 = function $$mk_talent_break_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_charm_break_table', TMP_MeikyuKingdom_mk_charm_break_table_25 = function $$mk_charm_break_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_search_break_table', TMP_MeikyuKingdom_mk_search_break_table_26 = function $$mk_search_break_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_valor_break_table', TMP_MeikyuKingdom_mk_valor_break_table_27 = function $$mk_valor_break_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_festival_break_table', TMP_MeikyuKingdom_mk_festival_break_table_28 = function $$mk_festival_break_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_festival_table', TMP_MeikyuKingdom_mk_festival_table_29 = function $$mk_festival_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_kingdom_disaster_table', TMP_MeikyuKingdom_mk_kingdom_disaster_table_30 = function $$mk_kingdom_disaster_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_talent_happening_table', TMP_MeikyuKingdom_mk_talent_happening_table_31 = function $$mk_talent_happening_table() {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_mk_talent_happening_table_31.$$arity = 0);
    
    Opal.defn(self, '$mk_charm_happening_table', TMP_MeikyuKingdom_mk_charm_happening_table_32 = function $$mk_charm_happening_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_search_happening_table', TMP_MeikyuKingdom_mk_search_happening_table_33 = function $$mk_search_happening_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_valor_happening_table', TMP_MeikyuKingdom_mk_valor_happening_table_34 = function $$mk_valor_happening_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_kingdom_change_table', TMP_MeikyuKingdom_mk_kingdom_change_table_35 = function $$mk_kingdom_change_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_kingdom_mischange_table', TMP_MeikyuKingdom_mk_kingdom_mischange_table_36 = function $$mk_kingdom_mischange_table() {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_mk_kingdom_mischange_table_36.$$arity = 0);
    
    Opal.defn(self, '$mk_critical_attack_table', TMP_MeikyuKingdom_mk_critical_attack_table_37 = function $$mk_critical_attack_table() {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_mk_critical_attack_table_37.$$arity = 0);
    
    Opal.defn(self, '$mk_fatal_wounds_table', TMP_MeikyuKingdom_mk_fatal_wounds_table_38 = function $$mk_fatal_wounds_table() {
      var self = this;
    ...
    }, TMP_MeikyuKingdom_mk_fatal_wounds_table_38.$$arity = 0);
    
    Opal.defn(self, '$mk_travel_table', TMP_MeikyuKingdom_mk_travel_table_39 = function $$mk_travel_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_negotiation_table', TMP_MeikyuKingdom_mk_negotiation_table_40 = function $$mk_negotiation_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_combat_fumble_table', TMP_MeikyuKingdom_mk_combat_fumble_table_41 = function $$mk_combat_fumble_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_emotion_table', TMP_MeikyuKingdom_mk_emotion_table_42 = function $$mk_emotion_table() {
      var self = this;

      return self.$get_table_by_1d3(["忠誠／怒り", "友情／不信", "愛情／侮蔑"])
    }, TMP_MeikyuKingdom_mk_emotion_table_42.$$arity = 0);
    
    Opal.defn(self, '$mk_market_price_table', TMP_MeikyuKingdom_mk_market_price_table_43 = function $$mk_market_price_table() {
      var self = this;

      return self.$get_table_by_2d6(["無し", "肉", "牙", "鉄", "魔素", "機械", "衣料", "木", "火薬", "情報", "革"])
    }, TMP_MeikyuKingdom_mk_market_price_table_43.$$arity = 0);
    
    Opal.defn(self, '$mk_treasure1_table', TMP_MeikyuKingdom_mk_treasure1_table_44 = function $$mk_treasure1_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_treasure2_table', TMP_MeikyuKingdom_mk_treasure2_table_45 = function $$mk_treasure2_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_treasure3_table', TMP_MeikyuKingdom_mk_treasure3_table_46 = function $$mk_treasure3_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_treasure4_table', TMP_MeikyuKingdom_mk_treasure4_table_47 = function $$mk_treasure4_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_treasure5_table', TMP_MeikyuKingdom_mk_treasure5_table_48 = function $$mk_treasure5_table() {
      var self = this;
    ...
    Opal.defn(self, '$mk_name_table', TMP_MeikyuKingdom_mk_name_table_49 = function $$mk_name_table() {
      ...
      dice = "" + (name_n) + "," + (d1) + "," + (d2);
      return [output, dice];
    }, TMP_MeikyuKingdom_mk_name_table_49.$$arity = 0);
    
    Opal.defn(self, '$mk_nick_a_table', TMP_MeikyuKingdom_mk_nick_a_table_50 = function $$mk_nick_a_table(output, num) {
      ...
      return output;
    }, TMP_MeikyuKingdom_mk_nick_a_table_50.$$arity = 2);
    
    Opal.defn(self, '$mk_nick_b_table', TMP_MeikyuKingdom_mk_nick_b_table_51 = function $$mk_nick_b_table(output, num) {
      var self = this, table = nil;
    ...
    }, TMP_MeikyuKingdom_mk_nick_b_table_51.$$arity = 2);
    
    Opal.defn(self, '$mk_name_a_table', TMP_MeikyuKingdom_mk_name_a_table_52 = function $$mk_name_a_table(num) {
      var self = this, table = nil;
    ...
    }, TMP_MeikyuKingdom_mk_name_a_table_52.$$arity = 1);
    
    Opal.defn(self, '$mk_name_b_table', TMP_MeikyuKingdom_mk_name_b_table_53 = function $$mk_name_b_table(num) {
      var self = this, table = nil;
      ...
      return self.$get_table_by_number(num, table);
    }, TMP_MeikyuKingdom_mk_name_b_table_53.$$arity = 1);
    
    Opal.defn(self, '$mk_name_ex_table', TMP_MeikyuKingdom_mk_name_ex_table_54 = function $$mk_name_ex_table(num) {
      var self = this, table = nil;
      ...
      return self.$get_table_by_number(num, table);
    }, TMP_MeikyuKingdom_mk_name_ex_table_54.$$arity = 1);
    
    Opal.defn(self, '$mk_name_fa_table', TMP_MeikyuKingdom_mk_name_fa_table_55 = function $$mk_name_fa_table(num) {
      var self = this, table = nil;
