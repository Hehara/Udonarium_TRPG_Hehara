...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$check_nD6', '$==', '$<=', '$>=', '$upcase', '$===', '$to_i', '$last_match', '$rollPerformance', '$textFrom1D6Table', '$textFromD66Table', '$getSkillList', '$badStatus', '$roll', '$+', '$[]', '$-', '$getSkillText', '$=~', '$getItem', '$get_table_by_1d6', '$index', '$nil?', '$push', '$setArrayFromD66Table', '$sort!', '$each', '$gsub', '$length', '$include?', '$costume', '$<', '$>', '$!', '$empty?', '$split', '$count', '$join', '$uniq', '$inject', '$map', '$to_proc', '$to_s', '$delete', '$sort', '$getD66', '$assoc', '$checkChance', '$replaceBadStatus', '$sub', '$chomp', '$loop', '$get_table_by_2d6', '$times', '$clone', '$first']);
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_BeginningIdol_Korean_initialize_1, TMP_BeginningIdol_Korean_gameName_2, TMP_BeginningIdol_Korean_gameType_3, TMP_BeginningIdol_Korean_getHelpMessage_4, TMP_BeginningIdol_Korean_check_2D6_5, TMP_BeginningIdol_Korean_check_nD6_6, TMP_BeginningIdol_Korean_rollDiceCommand_8, TMP_BeginningIdol_Korean_rollPerformance_10, TMP_BeginningIdol_Korean_textFromD66Table_11, TMP_BeginningIdol_Korean_checkChance_12, TMP_BeginningIdol_Korean_textFrom1D6Table_14, TMP_BeginningIdol_Korean_getSkillList_15, TMP_BeginningIdol_Korean_badStatus_17, TMP_BeginningIdol_Korean_getSkillText_18, TMP_BeginningIdol_Korean_setArrayFromD66Table_19, TMP_BeginningIdol_Korean_getItem_21, TMP_BeginningIdol_Korean_replaceBadStatus_22, TMP_BeginningIdol_Korean_costume_23;
    ...
    Opal.defn(self, '$initialize', TMP_BeginningIdol_Korean_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_BeginningIdol_Korean_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_BeginningIdol_Korean_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_BeginningIdol_Korean_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 2);
    }, TMP_BeginningIdol_Korean_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_BeginningIdol_Korean_gameName_2 = function $$gameName() {
      var self = this;

      return "비기닝 아이돌"
    }, TMP_BeginningIdol_Korean_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_BeginningIdol_Korean_gameType_3 = function $$gameType() {
      var self = this;

      return "BeginningIdol:Korean"
    }, TMP_BeginningIdol_Korean_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_BeginningIdol_Korean_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;

      return "" + "・퍼포먼스　[r]PDn[+m/-m](r：남은 주사위 눈　n：굴릴 갯수　m：수정치)\n" + "・월드세팅 업무표　BWT：대형 연예 프로덕션　LWT：약소 연예 프로덕션\n" + "　TWT：라이브 시어터　CWT：아이돌 부　LO[n]：로컬 아이돌(n：찬스)\n" + "　SU：열정의 여름　WI：온기의 겨울　NA：대자연　GA：女学園　BA：アカデミー\n" + "・업무표　WT　VA：버라이어티　MU：음악 관련　DR：드라마 관련\n" + "　VI：비주얼 관련　SP：스포츠　CHR：크리스마스　PAR：파트너 관련\n" + "・특기 리스트　AN：動物　MOV：映画　FA：ファンタジー\n" + "・ハプニング表　HA\n" + "・特技リスト　AT[n](n：分野No.)\n" + "・아이돌 스킬 습득표　SGT：챌린지 걸즈　RS：로드 투 프린스\n" + "・변조　BT[n](n：주사위눈)\n" + "・아이템　IT[n](n：보유 갯수)\n" + "・アクセサリー　ACT：種別決定　ACB：ブランド決定　ACE：効果表\n" + "・의상　DT：챌린지 걸즈　RC：로드 투 프린스　FC:フォーチュンスターズ\n" + "・엉망진창 표　LUR：로컬 아이돌　SUR：정열의 여름　WUR：온기의 겨울\n" + "　NUR：대자연　GUR：女学園　BUR：アカデミー\n" + "・센터 룰　HW：역풍 씬표　FL：신출내기 씬표　LN：고독표\n" + "　マイスキル【MS：名前決定　MSE：効果表】　演出表【ST　FST：ファンタジー】\n" + "・합숙 룰　산책표 【SH：쇼핑몰　MO：산　SEA：바다　SPA：온천】\n" + "　TN：야밤의 대화 시츄에이션　성장표 【CG：커먼　GG：골드】\n" + "・작사표　CHO　SCH：정열의 여름　WCH：온기의 겨울　NCH：대자연\n" + "・캐릭터 공백표　CBT：챌린지 걸즈　RCB：로드 투 프린스\n" + "・취미 공백표　HBT：챌린지 걸즈　RHB：로드 투 프린스\n" + "・마스코트 폭주표　RU\n" + "・버스트 타임　nC：バーストタイム(n：온도)　BU：バースト表\n" + "・攻撃　n[S]A[r][+m/-m](n：振る数　S：失敗しない　r：取り除く出目　m：修正値)\n" + "・かんたんパーソン表　SIP\n" + "・회장표\n" + "　BVT：대형 예능 프로덕션　LVT：약소 예능 프로덕션　TVT：라이브 시어터　CVT：아이돌 부\n" + "・장소표\n" + "　BST：대형 예능 프로덕션　LST：약소 예능 프로덕션　TST：라이브 시어터　CST：아이돌 부\n" + "・프레셔 종류 결정표\n" + "　BPT：대형 예능 프로덕션　LPT：약소 예능 프로덕션　TPT：라이브 시어터　CPT：아이돌 부\n" + "・도구표\n" + "　BIT：대형 예능 프로덕션　LIT：약소 예능 프로덕션　TIT：라이브 시어터　CIT：아이돌 부\n" + "[]内は省略可　D66 다이스가 존재\n"
    }, TMP_BeginningIdol_Korean_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$check_2D6', TMP_BeginningIdol_Korean_check_2D6_5 = function $$check_2D6(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      var self = this;

      return self.$check_nD6(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max)
    }, TMP_BeginningIdol_Korean_check_2D6_5.$$arity = 8);
    
    Opal.defn(self, '$check_nD6', TMP_BeginningIdol_Korean_check_nD6_6 = function $$check_nD6(total_n, dice_n, signOfInequality, diff, _dice_cnt, _dice_max, _n1, _n_max) {
      var self = this;
    ...
    }, TMP_BeginningIdol_Korean_check_nD6_6.$$arity = 8);
    
    Opal.defn(self, '$rollDiceCommand', TMP_BeginningIdol_Korean_rollDiceCommand_8 = function $$rollDiceCommand(command) {
      var $a, $b, TMP_7, self = this, $case = nil, counts = nil, residual = nil, adjust = nil, title = nil, table = nil, value = nil, table1 = nil, table2 = nil, number = nil, text = nil, skillTitle = nil, skillTable = nil, nameTable = nil, articleTitle = nil, articleTable = nil, describeTitle = nil, describeTable = nil, sceneTitle = nil, sceneTable = nil, materialTitle = nil, materialTable = nil, actionTitle = nil, actionTable = nil, name = nil, nameNumber = nil, nameParts = nil, articleIndex = nil, numberString = nil, bookTitle = nil, degrees = nil, total = nil, dice = nil, string = nil, sure = nil, remove = nil, result = nil;
...
if (_index == null) _index = nil;if (src == null) src = nil;if (text1 == null) text1 = nil;if (number1 == null) number1 = nil;
      ...
      return self.$textFrom1D6Table(title, table);};
      return nil;
    }, TMP_BeginningIdol_Korean_rollDiceCommand_8.$$arity = 1);
    
    Opal.defn(self, '$rollPerformance', TMP_BeginningIdol_Korean_rollPerformance_10 = function $$rollPerformance(counts, residual, adjust) {
...
if (i == null) i = nil;
    ...
    Opal.defn(self, '$textFromD66Table', TMP_BeginningIdol_Korean_textFromD66Table_11 = function $$textFromD66Table(title, table, chance) {
    ...
    }, TMP_BeginningIdol_Korean_textFromD66Table_11.$$arity = -3);
    
    Opal.defn(self, '$checkChance', TMP_BeginningIdol_Korean_checkChance_12 = function $$checkChance(text, skill, chance) {
      ...
      return [text, skill];
    }, TMP_BeginningIdol_Korean_checkChance_12.$$arity = 3);
    
    Opal.defn(self, '$textFrom1D6Table', TMP_BeginningIdol_Korean_textFrom1D6Table_14 = function $$textFrom1D6Table(title, table1, table2) {
    ...
    }, TMP_BeginningIdol_Korean_textFrom1D6Table_14.$$arity = -3);
    
    Opal.defn(self, '$getSkillList', TMP_BeginningIdol_Korean_getSkillList_15 = function $$getSkillList(field) {
    ...
    }, TMP_BeginningIdol_Korean_getSkillList_15.$$arity = -1);
    
    Opal.defn(self, '$badStatus', TMP_BeginningIdol_Korean_badStatus_17 = function $$badStatus(counts) {
...
if (i == null) i = nil;
    ...
    }, TMP_BeginningIdol_Korean_badStatus_17.$$arity = -1);
    
    Opal.defn(self, '$getSkillText', TMP_BeginningIdol_Korean_getSkillText_18 = function $$getSkillText(skill) {
      ...
      return "" + "\n" + (text);
    }, TMP_BeginningIdol_Korean_getSkillText_18.$$arity = 1);
    
    Opal.defn(self, '$setArrayFromD66Table', TMP_BeginningIdol_Korean_setArrayFromD66Table_19 = function $$setArrayFromD66Table(array, name, src, table) {
    ...
    }, TMP_BeginningIdol_Korean_setArrayFromD66Table_19.$$arity = 4);
    
    Opal.defn(self, '$getItem', TMP_BeginningIdol_Korean_getItem_21 = function $$getItem(counts) {
...
if (i == null) i = nil;
      ...
      text = text.$sub(/と$/, "");
      return text;
    }, TMP_BeginningIdol_Korean_getItem_21.$$arity = -1);
    
    Opal.defn(self, '$replaceBadStatus', TMP_BeginningIdol_Korean_replaceBadStatus_22 = function $$replaceBadStatus(text) {
    ...
    }, TMP_BeginningIdol_Korean_replaceBadStatus_22.$$arity = 1);
    return (Opal.defn(self, '$costume', TMP_BeginningIdol_Korean_costume_23 = function $$costume(title, brandOnly) {
      ...
      if ($truthy(brandOnly)) {
        text = text.$split("\n").$first()};
      return text;
    }, TMP_BeginningIdol_Korean_costume_23.$$arity = -2), nil) && 'costume';
