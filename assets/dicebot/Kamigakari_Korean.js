...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Kamigakari_Korean_initialize_1, TMP_Kamigakari_Korean_gameName_2, TMP_Kamigakari_Korean_gameType_3, TMP_Kamigakari_Korean_getHelpMessage_4, TMP_Kamigakari_Korean_rollDiceCommand_5, TMP_Kamigakari_Korean_getReimonCompensationTableResult_6, TMP_Kamigakari_Korean_getEmotionTableResult_7, TMP_Kamigakari_Korean_getNameTableResult_8, TMP_Kamigakari_Korean_getKyoukaiTableResult_9, TMP_Kamigakari_Korean_getGetMaterialTableResult_10, TMP_Kamigakari_Korean_getMaterialEffect_11, TMP_Kamigakari_Korean_getMaterialEffectNomal_12, TMP_Kamigakari_Korean_getMaterialEffectPower_13, TMP_Kamigakari_Korean_getMaterialEffectRare_14, TMP_Kamigakari_Korean_getAttribute_15, TMP_Kamigakari_Korean_getPrice_16;

    
    self.$setPrefixes(["RT", "MT(\\d*)", "ET", "NT", "KT"]);
    
    Opal.defn(self, '$initialize', TMP_Kamigakari_Korean_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_Kamigakari_Korean_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_Kamigakari_Korean_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_Kamigakari_Korean_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 1);
    }, TMP_Kamigakari_Korean_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_Kamigakari_Korean_gameName_2 = function $$gameName() {
      var self = this;

      return "카미가카리"
    }, TMP_Kamigakari_Korean_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_Kamigakari_Korean_gameType_3 = function $$gameType() {
      var self = this;

      return "Kamigakari:Korean"
    }, TMP_Kamigakari_Korean_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_Kamigakari_Korean_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;

      return "" + "・각종표\n" + " ・감정표(ET)\n" + " ・영문소비의 댓가표(RT)\n" + " ・전기 성씨・이름 결정표(NT)\n" + " ・마경임계표(KT)\n" + " ・획득 소재 차트(MTx x는［법칙장해］의［강도］.생략할 때는１)\n" + "　　예） MT　MT3　MT9\n" + "・D66주사위 가능\n"
    }, TMP_Kamigakari_Korean_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_Kamigakari_Korean_rollDiceCommand_5 = function $$rollDiceCommand(command) {
      ...
      return text;
    }, TMP_Kamigakari_Korean_rollDiceCommand_5.$$arity = 1);
    
    Opal.defn(self, '$getReimonCompensationTableResult', TMP_Kamigakari_Korean_getReimonCompensationTableResult_6 = function $$getReimonCompensationTableResult() {
    ...
    }, TMP_Kamigakari_Korean_getReimonCompensationTableResult_6.$$arity = 0);
    
    Opal.defn(self, '$getEmotionTableResult', TMP_Kamigakari_Korean_getEmotionTableResult_7 = function $$getEmotionTableResult() {
      ...
      return [tableName, result, number];
    }, TMP_Kamigakari_Korean_getEmotionTableResult_7.$$arity = 0);
    
    Opal.defn(self, '$getNameTableResult', TMP_Kamigakari_Korean_getNameTableResult_8 = function $$getNameTableResult() {
      var self = this, tableName = nil, table = nil, isSwap = nil, number = nil, result = nil;
      ...
      result = self.$get_table_by_number(number, table);
      return [tableName, result, number];
    }, TMP_Kamigakari_Korean_getNameTableResult_8.$$arity = 0);
    
    Opal.defn(self, '$getKyoukaiTableResult', TMP_Kamigakari_Korean_getKyoukaiTableResult_9 = function $$getKyoukaiTableResult() {
      var self = this, tableName = nil, table = nil, isSwap = nil, number = nil, result = nil;
      ...
      result = self.$get_table_by_number(number, table);
      return [tableName, result, number];
    }, TMP_Kamigakari_Korean_getKyoukaiTableResult_9.$$arity = 0);
    
    Opal.defn(self, '$getGetMaterialTableResult', TMP_Kamigakari_Korean_getGetMaterialTableResult_10 = function $$getGetMaterialTableResult(rank) {
      ...
      return [tableName, result, number];
    }, TMP_Kamigakari_Korean_getGetMaterialTableResult_10.$$arity = 1);
    
    Opal.defn(self, '$getMaterialEffect', TMP_Kamigakari_Korean_getMaterialEffect_11 = function $$getMaterialEffect(rank) {
    ...
    }, TMP_Kamigakari_Korean_getMaterialEffect_11.$$arity = 1);
    
    Opal.defn(self, '$getMaterialEffectNomal', TMP_Kamigakari_Korean_getMaterialEffectNomal_12 = function $$getMaterialEffectNomal(rank) {
      ...
      if ($truthy(/\+n/['$==='](result))) {
        ...
        number = "" + (number) + "," + (number2);};
      return [result, number];
    }, TMP_Kamigakari_Korean_getMaterialEffectNomal_12.$$arity = 1);
    
    Opal.defn(self, '$getMaterialEffectPower', TMP_Kamigakari_Korean_getMaterialEffectPower_13 = function $$getMaterialEffectPower(rank) {
      ...
      return [power, number];
    }, TMP_Kamigakari_Korean_getMaterialEffectPower_13.$$arity = 1);
    
    Opal.defn(self, '$getMaterialEffectRare', TMP_Kamigakari_Korean_getMaterialEffectRare_14 = function $$getMaterialEffectRare() {
      ...
      if ($truthy(/\*\*/['$==='](result))) {
        ...
        number = "" + (number) + "," + (number2);};
      return [result, number];
    }, TMP_Kamigakari_Korean_getMaterialEffectRare_14.$$arity = 0);
    
    Opal.defn(self, '$getAttribute', TMP_Kamigakari_Korean_getAttribute_15 = function $$getAttribute() {
    ...
    return (Opal.defn(self, '$getPrice', TMP_Kamigakari_Korean_getPrice_16 = function $$getPrice(effect) {
      ...
      price = table['$[]'](power);
      return price;
    }, TMP_Kamigakari_Korean_getPrice_16.$$arity = 1), nil) && 'getPrice';
