...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Amadeus_Korean_initialize_1, TMP_Amadeus_Korean_gameName_2, TMP_Amadeus_Korean_gameType_3, TMP_Amadeus_Korean_getHelpMessage_4, TMP_Amadeus_Korean_rollDiceCommand_5, TMP_Amadeus_Korean_amadeusDice_8, TMP_Amadeus_Korean_check_success_9, $a;

    
    
    Opal.defn(self, '$initialize', TMP_Amadeus_Korean_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_Amadeus_Korean_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_Amadeus_Korean_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_Amadeus_Korean_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 2);
    }, TMP_Amadeus_Korean_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_Amadeus_Korean_gameName_2 = function $$gameName() {
      var self = this;

      return "아마데우스"
    }, TMP_Amadeus_Korean_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_Amadeus_Korean_gameType_3 = function $$gameType() {
      var self = this;

      return "Amadeus:Korean"
    }, TMP_Amadeus_Korean_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_Amadeus_Korean_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;
    ...
    }, TMP_Amadeus_Korean_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_Amadeus_Korean_rollDiceCommand_5 = function $$rollDiceCommand(command) {
      ...
      info = (($a = $Amadeus_Korean.$$cvars['@@tables']) == null ? nil : $a)['$[]'](command.$upcase());
      if ($truthy(info['$nil?']())) {
        return nil};
      name = info['$[]']("name");
      type = info['$[]']("type");
    ...
    Opal.defn(self, '$amadeusDice', TMP_Amadeus_Korean_amadeusDice_8 = function $$amadeusDice(command) {
      ...
      diceCount = (($a = $Amadeus_Korean.$$cvars['@@checkDiceCount']) == null ? nil : $a)['$[]'](skillRank);
...
if (dice == null) dice = nil;
    ...
    Opal.defn(self, '$check_success', TMP_Amadeus_Korean_check_success_9 = function $$check_success(total_n, dice_n, signOfInequality, diff, special_n) {
