...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_DeadlineHeroes_gameName_1, TMP_DeadlineHeroes_gameType_2, TMP_DeadlineHeroes_getHelpMessage_3, TMP_DeadlineHeroes_rollDiceCommand_4, TMP_DeadlineHeroes_resolute_action_5, TMP_DeadlineHeroes_roll_d100_6, TMP_DeadlineHeroes_fetchDeathChart_7, TMP_DeadlineHeroes_fetchFromChart_8, TMP_DeadlineHeroes_getDeathChartByName_9, TMP_DeadlineHeroes_fetchResultFromRealNameChart_12, TMP_DeadlineHeroes_getRealNameChartByName_13, TMP_DeadlineHeroes_rollHeroNameTemplateChart_17, TMP_DeadlineHeroes_getHeroNameElementText_18, TMP_DeadlineHeroes_rollHeroNameBaseChart_19, TMP_DeadlineHeroes_rollHeroNameElementChart_20, TMP_DeadlineHeroes_getHeroNameTemplateChart_21, TMP_DeadlineHeroes_getHeroNameBaseChartByName_22, TMP_DeadlineHeroes_getHeroNameElementChartByName_23;
    ...
    Opal.const_set($nesting[0], 'CRITICAL_STR', $rb_plus(Opal.const_get_relative($nesting, 'SUCCESS_STR'), " ＞ クリティカル！ パワーの代償１／２").$freeze());
    Opal.const_set($nesting[0], 'FUMBLE_STR', $rb_plus(Opal.const_get_relative($nesting, 'FAILURE_STR'), " ＞ ファンブル！ パワーの代償２倍＆振り直し不可").$freeze());
    
    Opal.defn(self, '$resolute_action', TMP_DeadlineHeroes_resolute_action_5 = function $$resolute_action(expressions) {
      ...
      if ($truthy(($truthy($a = roll_result['$=='](100)) ? $a : $rb_le(success_rate, 0)))) {
        ...
        text = $rb_plus(text, Opal.const_get_relative($nesting, 'CRITICAL_STR'))
      } else if ($truthy($rb_le(roll_result, success_rate))) {
        text = $rb_plus(text, (function() {if (dice10['$=='](dice01)) {
          return Opal.const_get_relative($nesting, 'CRITICAL_STR')
          } else {
          return Opal.const_get_relative($nesting, 'SUCCESS_STR')
        }; return nil; })())
        } else {
        text = $rb_plus(text, (function() {if (dice10['$=='](dice01)) {
          return Opal.const_get_relative($nesting, 'FUMBLE_STR')
          } else {
          return Opal.const_get_relative($nesting, 'FAILURE_STR')
        }; return nil; })())
      };
      return text;
    }, TMP_DeadlineHeroes_resolute_action_5.$$arity = 1);
    
    Opal.defn(self, '$roll_d100', TMP_DeadlineHeroes_roll_d100_6 = function $$roll_d100() {
    ...
    }, TMP_DeadlineHeroes_roll_d100_6.$$arity = 0);
    
    Opal.defn(self, '$fetchDeathChart', TMP_DeadlineHeroes_fetchDeathChart_7 = function $$fetchDeathChart(chartName, minusScore) {
    ...
    }, TMP_DeadlineHeroes_fetchDeathChart_7.$$arity = 2);
    
    Opal.defn(self, '$fetchFromChart', TMP_DeadlineHeroes_fetchFromChart_8 = function $$fetchFromChart(keyNumber, chart) {
      ...
      return ["未定義", "？？？"];
    }, TMP_DeadlineHeroes_fetchFromChart_8.$$arity = 2);
    
    Opal.defn(self, '$getDeathChartByName', TMP_DeadlineHeroes_getDeathChartByName_9 = function $$getDeathChartByName(chartName) {
      var $a, self = this;
    ...
    Opal.defn(self, '$fetchResultFromRealNameChart', TMP_DeadlineHeroes_fetchResultFromRealNameChart_12 = function $$fetchResultFromRealNameChart(keyNumber, chartInfo) {
      var $a, $b, TMP_10, TMP_11, self = this, columns = nil, chart = nil, range = nil, elements = nil, result = nil, nameTextList = nil;
...
if (range == null) range = nil;if (_elements == null) _elements = nil;
      ...
      if ($truthy($rb_le(elements.$size(), 1))) {
        ...
        return result;};
      nameTextList = [];
      $send(columns, 'each_with_index', [], (TMP_11 = function(title, i){var self = TMP_11.$$s || this, text = nil;
if (title == null) title = nil;if (i == null) i = nil;
      
        text = elements['$[]'](i);
        if ($truthy(text['$nil?']())) {
          return nil;};
        return nameTextList['$<<']("" + (title) + ": " + (text));}, TMP_11.$$s = self, TMP_11.$$arity = 2, TMP_11));
      result = $rb_plus(result, nameTextList.$join("\n"));
      return result;
    }, TMP_DeadlineHeroes_fetchResultFromRealNameChart_12.$$arity = 2);
    
    Opal.defn(self, '$getRealNameChartByName', TMP_DeadlineHeroes_getRealNameChartByName_13 = function $$getRealNameChartByName(chartName) {
      var $a, self = this;
    ...
    }, TMP_DeadlineHeroes_getRealNameChartByName_13.$$arity = 1);
    ...
    Opal.defn(self, '$rollHeroNameTemplateChart', TMP_DeadlineHeroes_rollHeroNameTemplateChart_17 = function $$rollHeroNameTemplateChart() {
      var $a, $b, TMP_14, TMP_15, TMP_16, self = this, chart = nil, dice = nil, templateText = nil, result = nil, elements = nil, resolvedElements = nil, text = nil, resultText = nil, $writer = nil;
      ...
      resolvedElements = $send(elements, 'map', [], (TMP_14 = function(i){var self = TMP_14.$$s || this;
if (i == null) i = nil;
      return self.$rollHeroNameBaseChart(i)}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14));
      text = $send(resolvedElements, 'map', [], (TMP_15 = function(i){var self = TMP_15.$$s || this;
if (i == null) i = nil;
      return self.$getHeroNameElementText(i)}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15)).$join(" ＋ ");
      resultText = $send(resolvedElements, 'map', [], (TMP_16 = function(i){var self = TMP_16.$$s || this;
if (i == null) i = nil;
      return i['$[]']("coreResult")}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16)).$join("").$sub(/・{2,}/, "・").$sub(/・$/, "");
      
      $writer = ["result", $rb_plus(result['$[]']("result"), "" + " ＞ ( " + (text) + " ) ＞ 「" + (resultText) + "」")];
      $send(result, '[]=', Opal.to_a($writer));
      $writer[$rb_minus($writer["length"], 1)];;
      return result;
    }, TMP_DeadlineHeroes_rollHeroNameTemplateChart_17.$$arity = 0);
    
    Opal.defn(self, '$getHeroNameElementText', TMP_DeadlineHeroes_getHeroNameElementText_18 = function $$getHeroNameElementText(info) {
    ...
    Opal.defn(self, '$rollHeroNameBaseChart', TMP_DeadlineHeroes_rollHeroNameBaseChart_19 = function $$rollHeroNameBaseChart(chartName) {
      ...
      if ($truthy(result['$[]']("result")['$=~'](/［(.+)］/))) {
        ...
        $writer[$rb_minus($writer["length"], 1)];;};
      return result;
    }, TMP_DeadlineHeroes_rollHeroNameBaseChart_19.$$arity = 1);
    
    Opal.defn(self, '$rollHeroNameElementChart', TMP_DeadlineHeroes_rollHeroNameElementChart_20 = function $$rollHeroNameElementChart(chartName) {
    ...
    }, TMP_DeadlineHeroes_rollHeroNameElementChart_20.$$arity = 1);
    
    Opal.defn(self, '$getHeroNameTemplateChart', TMP_DeadlineHeroes_getHeroNameTemplateChart_21 = function $$getHeroNameTemplateChart() {
      var $a, self = this;

      return (($a = $DeadlineHeroes.$$cvars['@@heroNameTemplates']) == null ? nil : $a)
    }, TMP_DeadlineHeroes_getHeroNameTemplateChart_21.$$arity = 0);
    
    Opal.defn(self, '$getHeroNameBaseChartByName', TMP_DeadlineHeroes_getHeroNameBaseChartByName_22 = function $$getHeroNameBaseChartByName(chartName) {
      var $a, self = this;

      return (($a = $DeadlineHeroes.$$cvars['@@heroNameBaseCharts']) == null ? nil : $a)['$[]'](chartName)
    }, TMP_DeadlineHeroes_getHeroNameBaseChartByName_22.$$arity = 1);
    
    Opal.defn(self, '$getHeroNameElementChartByName', TMP_DeadlineHeroes_getHeroNameElementChartByName_23 = function $$getHeroNameElementChartByName(chartName) {
      var $a, self = this;

      return (($a = $DeadlineHeroes.$$cvars['@@heroNameElementCharts']) == null ? nil : $a)['$[]'](chartName)
    }, TMP_DeadlineHeroes_getHeroNameElementChartByName_23.$$arity = 1);
