...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    function $MonotoneMusium_Korean(){};
    var self = $MonotoneMusium_Korean = $klass($base, $super, 'MonotoneMusium_Korean', $MonotoneMusium_Korean);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MonotoneMusium_Korean_initialize_1, TMP_MonotoneMusium_Korean_gameName_2, TMP_MonotoneMusium_Korean_gameType_3, TMP_MonotoneMusium_Korean_getHelpMessage_4, TMP_MonotoneMusium_Korean_rollDiceCommand_5, TMP_MonotoneMusium_Korean_checkRoll_6, TMP_MonotoneMusium_Korean_rollTableCommand_7, TMP_MonotoneMusium_Korean_mm_emotion_table_8, TMP_MonotoneMusium_Korean_mm_emotion_table_ver2_9, TMP_MonotoneMusium_Korean_mm_omens_table_10, TMP_MonotoneMusium_Korean_mm_distortion_table_11, TMP_MonotoneMusium_Korean_mm_distortion_table_ver2_12, TMP_MonotoneMusium_Korean_mm_world_distortion_table_13;

    def.sortType = nil;
    
    self.$setPrefixes(["2D6.*", "ET", "ET2", "OT", "DT", "DT2", "WDT"]);
    
    Opal.defn(self, '$initialize', TMP_MonotoneMusium_Korean_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_MonotoneMusium_Korean_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_MonotoneMusium_Korean_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_MonotoneMusium_Korean_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.d66Type = 1;
      return (self.sortType = 1);
    }, TMP_MonotoneMusium_Korean_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_MonotoneMusium_Korean_gameName_2 = function $$gameName() {
      var self = this;

      return "모노톤 뮤지엄"
    }, TMP_MonotoneMusium_Korean_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_MonotoneMusium_Korean_gameType_3 = function $$gameType() {
      var self = this;

      return "MonotoneMusium:Korean"
    }, TMP_MonotoneMusium_Korean_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_MonotoneMusium_Korean_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;

      return "" + "・판정\n" + "　・통상판정　　　　　　2D6+m>=t[c,f]\n" + "　　수정치m,목표치t,크리티컬치c,펌블치f로 판정 굴림을 행합니다.\n" + "　　크리티컬, 펌블치는 생략가능합니다. ([]자체를 생략가능)\n" + "　　자동성공, 자동실패, 성공, 실패를 자동표기합니다.\n" + "・각종표\n" + "　・감정표　ET／감정표 2.0　ET2\n" + "　・징조표　　OT\n" + "　・일그러짐표　DT／일그러짐표ver2.0　DT2\n" + "　・세계왜곡표　　WDT\n" + "・D66다이스 있음\n"
    }, TMP_MonotoneMusium_Korean_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$rollDiceCommand', TMP_MonotoneMusium_Korean_rollDiceCommand_5 = function $$rollDiceCommand(command) {
    ...
    }, TMP_MonotoneMusium_Korean_rollDiceCommand_5.$$arity = 1);
    
    Opal.defn(self, '$checkRoll', TMP_MonotoneMusium_Korean_checkRoll_6 = function $$checkRoll(string) {
      ...
      return output;
    }, TMP_MonotoneMusium_Korean_checkRoll_6.$$arity = 1);
    
    Opal.defn(self, '$rollTableCommand', TMP_MonotoneMusium_Korean_rollTableCommand_7 = function $$rollTableCommand(command) {
      ...
      return output;
    }, TMP_MonotoneMusium_Korean_rollTableCommand_7.$$arity = 1);
    
    Opal.defn(self, '$mm_emotion_table', TMP_MonotoneMusium_Korean_mm_emotion_table_8 = function $$mm_emotion_table() {
    ...
    }, TMP_MonotoneMusium_Korean_mm_emotion_table_8.$$arity = 0);
    
    Opal.defn(self, '$mm_emotion_table_ver2', TMP_MonotoneMusium_Korean_mm_emotion_table_ver2_9 = function $$mm_emotion_table_ver2() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_Korean_mm_emotion_table_ver2_9.$$arity = 0);
    
    Opal.defn(self, '$mm_omens_table', TMP_MonotoneMusium_Korean_mm_omens_table_10 = function $$mm_omens_table() {
      var self = this, table = nil;
    ...
    }, TMP_MonotoneMusium_Korean_mm_omens_table_10.$$arity = 0);
    
    Opal.defn(self, '$mm_distortion_table', TMP_MonotoneMusium_Korean_mm_distortion_table_11 = function $$mm_distortion_table() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_2d6(table);
    }, TMP_MonotoneMusium_Korean_mm_distortion_table_11.$$arity = 0);
    
    Opal.defn(self, '$mm_distortion_table_ver2', TMP_MonotoneMusium_Korean_mm_distortion_table_ver2_12 = function $$mm_distortion_table_ver2() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_d66(table);
    }, TMP_MonotoneMusium_Korean_mm_distortion_table_ver2_12.$$arity = 0);
    return (Opal.defn(self, '$mm_world_distortion_table', TMP_MonotoneMusium_Korean_mm_world_distortion_table_13 = function $$mm_world_distortion_table() {
      var self = this, table = nil;
      ...
      return self.$get_table_by_2d6(table);
    }, TMP_MonotoneMusium_Korean_mm_world_distortion_table_13.$$arity = 0), nil) && 'mm_world_distortion_table';
