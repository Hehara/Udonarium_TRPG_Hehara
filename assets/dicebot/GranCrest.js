...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$check_nD6', '$debug', '$>=', '$+', '$==', '$===', '$getMeetingTableResult', '$getFeelingTableResult', '$getCountryTableResult', '$get_table_by_d66', '$=~', '$get_table_by_1d6']);
  return (function($base, $super, $parent_nesting) {
    function $GranCrest(){};
    var self = $GranCrest = $klass($base, $super, 'GranCrest', $GranCrest);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_GranCrest_initialize_1, TMP_GranCrest_gameName_2, TMP_GranCrest_gameType_3, TMP_GranCrest_getHelpMessage_4, TMP_GranCrest_check_2D6_5, TMP_GranCrest_check_nD6_6, TMP_GranCrest_rollDiceCommand_7, TMP_GranCrest_getMeetingTableResult_8, TMP_GranCrest_getFeelingTableResult_9, TMP_GranCrest_getCountryTableResult_10;

    
    self.$setPrefixes(["MT", "PFT", "NFT", "CT", "TCT", "ICT", "PCT", "OCT", "BCT", "CCT"]);
    
    Opal.defn(self, '$initialize', TMP_GranCrest_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_GranCrest_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_GranCrest_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_GranCrest_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      self.d66Type = 1;
      return (self.fractionType = "omit");
    }, TMP_GranCrest_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_GranCrest_gameName_2 = function $$gameName() {
      var self = this;

      return "グランクレスト"
    }, TMP_GranCrest_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_GranCrest_gameType_3 = function $$gameType() {
      var self = this;

      return "GranCrest"
    }, TMP_GranCrest_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_GranCrest_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;

      return "" + "・2D6の目標値判定でクリティカル処理\n" + "　例）3d6>=19 3d6+5>=24\n" + "・邂逅表（MT）\n" + "・感情表（-FT）\n" + "　ポジティブ感情表（PFT）、ネガティブ感情表（NFT）\n" + "・国特徴表（-CT）\n" + "　カテゴリー表（CT）、地形表（TCT）、産業表（ICT）、人物表（PCT）\n" + "　組織表（OCT）、拠点表（BCT）、文化表（CCT）\n"
    }, TMP_GranCrest_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$check_2D6', TMP_GranCrest_check_2D6_5 = function $$check_2D6(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      var self = this;
    ...
    Opal.defn(self, '$check_nD6', TMP_GranCrest_check_nD6_6 = function $$check_nD6(total_n, _dice_n, signOfInequality, diff, _dice_cnt, _dice_max, _n1, n_max) {
      ...
      return result;
    }, TMP_GranCrest_check_nD6_6.$$arity = 8);
    
    Opal.defn(self, '$rollDiceCommand', TMP_GranCrest_rollDiceCommand_7 = function $$rollDiceCommand(command) {
      ...
      return text;
    }, TMP_GranCrest_rollDiceCommand_7.$$arity = 1);
    
    Opal.defn(self, '$getMeetingTableResult', TMP_GranCrest_getMeetingTableResult_8 = function $$getMeetingTableResult() {
    ...
    }, TMP_GranCrest_getMeetingTableResult_8.$$arity = 0);
    
    Opal.defn(self, '$getFeelingTableResult', TMP_GranCrest_getFeelingTableResult_9 = function $$getFeelingTableResult(command) {
      ...
      return [tableName, result, number];
    }, TMP_GranCrest_getFeelingTableResult_9.$$arity = 1);
    return (Opal.defn(self, '$getCountryTableResult', TMP_GranCrest_getCountryTableResult_10 = function $$getCountryTableResult(command) {
      ...
      return [tableName, result, number];
    }, TMP_GranCrest_getCountryTableResult_10.$$arity = 1), nil) && 'getCountryTableResult';
