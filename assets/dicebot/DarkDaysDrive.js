...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_DarkDaysDrive_initialize_1, TMP_DarkDaysDrive_gameName_2, TMP_DarkDaysDrive_gameType_3, TMP_DarkDaysDrive_getHelpMessage_4, TMP_DarkDaysDrive_check_2D6_5, TMP_DarkDaysDrive_rollDiceCommand_6, TMP_DarkDaysDrive_getRandomSkillTableResult_7, TMP_DarkDaysDrive_getTableDiceCommandResult_8, TMP_DarkDaysDrive_getD66Table_10, $a;

    
    
    Opal.defn(self, '$initialize', TMP_DarkDaysDrive_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_DarkDaysDrive_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_DarkDaysDrive_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_DarkDaysDrive_initialize_1, false), $zuper, $iter);
      return (self.d66Type = 2);
    }, TMP_DarkDaysDrive_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_DarkDaysDrive_gameName_2 = function $$gameName() {
      var self = this;
    ...
    Opal.defn(self, '$check_2D6', TMP_DarkDaysDrive_check_2D6_5 = function $$check_2D6(total_n, dice_n, signOfInequality, diff, _dice_cnt, _dice_max, _n1, _n_max) {
      ...
      return output;
    }, TMP_DarkDaysDrive_check_2D6_5.$$arity = 8);
    
    Opal.defn(self, '$rollDiceCommand', TMP_DarkDaysDrive_rollDiceCommand_6 = function $$rollDiceCommand(command) {
    ...
    Opal.defn(self, '$getRandomSkillTableResult', TMP_DarkDaysDrive_getRandomSkillTableResult_7 = function $$getRandomSkillTableResult(_command) {
      ...
      return output;
    }, TMP_DarkDaysDrive_getRandomSkillTableResult_7.$$arity = 1);
    
    Opal.defn(self, '$getTableDiceCommandResult', TMP_DarkDaysDrive_getTableDiceCommandResult_8 = function $$getTableDiceCommandResult(command) {
      var $a, $b, self = this, info = nil, name = nil, type = nil, table = nil, $case = nil, isSwap = nil, number = nil, result = nil, text = nil;

      
      info = (($a = $DarkDaysDrive.$$cvars['@@tables']) == null ? nil : $a)['$[]'](command);
      if ($truthy(info['$nil?']())) {
        return nil};
      name = info['$[]']("name");
      type = info['$[]']("type");
    ...
    }, TMP_DarkDaysDrive_getTableDiceCommandResult_8.$$arity = 1);
    
    Opal.defn(self, '$getD66Table', TMP_DarkDaysDrive_getD66Table_10 = function $$getD66Table(table) {
      var TMP_9, self = this;
