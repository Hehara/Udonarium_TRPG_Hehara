...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_KillDeathBusiness_Korean_initialize_1, TMP_KillDeathBusiness_Korean_gameName_2, TMP_KillDeathBusiness_Korean_gameType_3, TMP_KillDeathBusiness_Korean_getHelpMessage_4, TMP_KillDeathBusiness_Korean_check_2D6_5, TMP_KillDeathBusiness_Korean_rollDiceCommand_6, TMP_KillDeathBusiness_Korean_judgeDice_7, TMP_KillDeathBusiness_Korean_rollTableCommand_8, TMP_KillDeathBusiness_Korean_getHistoryTableResult_9, TMP_KillDeathBusiness_Korean_getSceneTableResult_10, TMP_KillDeathBusiness_Korean_getWishTableResult_11, TMP_KillDeathBusiness_Korean_getNameTableResult_12, TMP_KillDeathBusiness_Korean_getSubprotTableResult_13, TMP_KillDeathBusiness_Korean_getCmTableResult_14, TMP_KillDeathBusiness_Korean_getErTableResult_15, TMP_KillDeathBusiness_Korean_getWKTableResult_16, TMP_KillDeathBusiness_Korean_getServiceSceneTableResult_17, TMP_KillDeathBusiness_Korean_getSoulTableResult_18, TMP_KillDeathBusiness_Korean_getSceneTelopGenericTableResult_19, TMP_KillDeathBusiness_Korean_getHairStylistAbuseTableResult_20, TMP_KillDeathBusiness_Korean_getSkillTableResult_21, TMP_KillDeathBusiness_Korean_getExtraTableResult_22, TMP_KillDeathBusiness_Korean_getpcTableResult_23, TMP_KillDeathBusiness_Korean_getohTableResult_24, TMP_KillDeathBusiness_Korean_getplTableResult_25, TMP_KillDeathBusiness_Korean_getprTableResult_26, TMP_KillDeathBusiness_Korean_getpnTableResult_27, TMP_KillDeathBusiness_Korean_getpdTableResult_28, TMP_KillDeathBusiness_Korean_getpfTableResult_29, TMP_KillDeathBusiness_Korean_getpgTableResult_30, TMP_KillDeathBusiness_Korean_getpbTableResult_31;

    
    self.$setPrefixes(["HST", "ST[1-2]?", "DWT", "DeathWT", "RWT", "RevengeWT", "VWT", "VictoryWT", "PWT", "PossesionWT", "CWT", "ControlWT", "FWT", "FlourishWT", "IWT", "IntensifyWT", "HWT", "HealthWT", "SaWT", "SafetyWT", "LWT", "LongevityWT", "EWT", "ExistWT", "NAME[1-3]?", "NAME[1-3]?", "OSPT", "OccultSPT", "FSPT", "FamilySPT", "LoSPT", "LoveSPT", "JSPT", "JusticeSPT", "TSPT", "TrainingSPT", "BSPT", "BeamSPT", "CMT", "EST", "sErviceST", "SOUL", "STGT", "HSAT[1-2]?", "EXT[1-4]?", "SKLT", "SKLJ", "ERT", "WKT", "PCDT", "OHT", "PCT1", "PCT2", "PCT3", "PCT4", "PCT5", "PCT6", "PCT7", "JD.*"]);
    
    Opal.defn(self, '$initialize', TMP_KillDeathBusiness_Korean_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_KillDeathBusiness_Korean_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_KillDeathBusiness_Korean_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_KillDeathBusiness_Korean_initialize_1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 2);
    }, TMP_KillDeathBusiness_Korean_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_KillDeathBusiness_Korean_gameName_2 = function $$gameName() {
      var self = this;

      return "Kill Death Business (한국어)"
    }, TMP_KillDeathBusiness_Korean_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_KillDeathBusiness_Korean_gameType_3 = function $$gameType() {
      var self = this;

      return "KillDeathBusiness:Korean"
    }, TMP_KillDeathBusiness_Korean_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_KillDeathBusiness_Korean_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;
    ...
    }, TMP_KillDeathBusiness_Korean_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$check_2D6', TMP_KillDeathBusiness_Korean_check_2D6_5 = function $$check_2D6(total_n, dice_n, signOfInequality, diff, dice_cnt, dice_max, n1, n_max) {
      ...
      output = (function() {if ($truthy($rb_le(dice_n, 2))) {
        return " ＞ 펌블(판정 실패.【시청률】이 20%감소)"
      } else if ($truthy($rb_ge(dice_n, 12))) {
        return " ＞ 스페셜(판정 성공.【시청률】이 10%증가)"
      ...
      return output;
    }, TMP_KillDeathBusiness_Korean_check_2D6_5.$$arity = 8);
    
    Opal.defn(self, '$rollDiceCommand', TMP_KillDeathBusiness_Korean_rollDiceCommand_6 = function $$rollDiceCommand(command) {
      var $a, self = this, $case = nil, result = nil, text = nil;

      
      self.$debug("rollDiceCommand command", command);
      $case = command;
      if ((($a = $KillDeathBusiness_Korean.$$cvars['@@judogeDiceReg']) == null ? nil : $a)['$===']($case)) {
      result = self.$judgeDice(command);
      text = "" + "판정" + (result);
      return text;};
      return self.$rollTableCommand(command);
    }, TMP_KillDeathBusiness_Korean_rollDiceCommand_6.$$arity = 1);
    (Opal.class_variable_set($KillDeathBusiness_Korean, '@@judogeDiceReg', /(^|\s)JD(\d+)([\+\-]\d+)?(,(\d+))?($|\s)/i));
    
    Opal.defn(self, '$judgeDice', TMP_KillDeathBusiness_Korean_judgeDice_7 = function $$judgeDice(command) {
      var $a, $b, self = this, target = nil, modify = nil, fumble = nil, result = nil, number = nil, diceText = nil;

      
      if ($truthy((($a = $KillDeathBusiness_Korean.$$cvars['@@judogeDiceReg']) == null ? nil : $a)['$==='](command))) {
        } else {
        return "1"
      };
      ...
      if ($truthy($rb_gt(target, 12))) {
        ...
        result = $rb_plus(result, "" + "【" + (command) + "】 ＞ 난이도가 12이상은 스페셜만 성공.\n");
        target = 12;};
      if ($truthy($rb_lt(target, 5))) {
        
        result = $rb_plus(result, "" + "【" + (command) + "】 ＞ 난이도의 최저치는 5.\n");
        target = 5;};
      if ($truthy($rb_lt(fumble, 2))) {
        fumble = 2
      } else if ($truthy($rb_gt(fumble, 11))) {
        
        result = $rb_plus(result, "" + "【" + (command) + "】 ＞ 스페셜을 내면 반드시 성공이므로, 펌블치은 11으로 한다.\n");
        fumble = 11;};
      ...
      if (number['$=='](2)) {
        ...
        if ($truthy($rb_lt(number, target))) {
          result = $rb_plus(result, "" + "달성치" + (number) + "、난이도미만이므로 판정 실패!")
          } else {
          result = $rb_plus(result, "" + "달성치" + (number) + "、난이도이상이므로 판정 성공!")
        };
      };
      return result;
    }, TMP_KillDeathBusiness_Korean_judgeDice_7.$$arity = 1);
    
    Opal.defn(self, '$rollTableCommand', TMP_KillDeathBusiness_Korean_rollTableCommand_8 = function $$rollTableCommand(command) {
      var $a, $b, self = this, tableName = nil, result = nil, $case = nil, number = nil, type = nil, text = nil;
      ...
      return text;
    }, TMP_KillDeathBusiness_Korean_rollTableCommand_8.$$arity = 1);
    
    Opal.defn(self, '$getHistoryTableResult', TMP_KillDeathBusiness_Korean_getHistoryTableResult_9 = function $$getHistoryTableResult() {
    ...
    }, TMP_KillDeathBusiness_Korean_getHistoryTableResult_9.$$arity = 0);
    
    Opal.defn(self, '$getSceneTableResult', TMP_KillDeathBusiness_Korean_getSceneTableResult_10 = function $$getSceneTableResult(type) {
      ...
      number = "" + (num1) + "," + (num2);};
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getSceneTableResult_10.$$arity = 1);
    
    Opal.defn(self, '$getWishTableResult', TMP_KillDeathBusiness_Korean_getWishTableResult_11 = function $$getWishTableResult(command) {
      ...
      tableName = "소원표「죽음」";
      table = ["지금의 아름다움을 유지한 채 죽고 싶다.", "재밌는 방법으로 죽어보고 싶다.", "자살할 용기가 없어서 죽고 싶다.", "죽으면 어떻게 될지 보고 싶다.", "너무나 싫은 일이 있어서 죽고 싶다.", "불로불사가 질려서 죽고 싶다."];}
      else if (/^RWT$/i['$===']($case) || /^RevengeWT$/i['$===']($case)) {
      tableName = "소원표「복수」";
      table = ["가족을 죽인 범인에게 복수하고 싶다.", "자신보다 행복한 이웃에게 복수하고 싶다.", "자신을 배반한 친구에게 복수하고 싶다.", "자신을 버린 애인에게 복수하고 싶다.", "소중한 것을 빼앗은 범인에게 복수하고 싶다.", "처참한 패배를 안겨준 라이벌에게 복수하고 싶다."];}
      else if (/^VWT$/i['$===']($case) || /^VictoryWT$/i['$===']($case)) {
      tableName = "소원표「승리」";
      table = ["이전에 졌던 라이벌에게 이기고 싶다.", "쓰러트리고 싶은 유명인(고인)이 있다.", "쓰러트리고 싶은 유명인이 있다.", "특정 업계에서 제일의 실력자가 되고 싶다.", "특정 게임에서 최강의 플레이어가 되고 싶다.", "특정 테스트에서 1위를 하고 싶다."];}
      else if (/^PWT$/i['$===']($case) || /^PossesionWT$/i['$===']($case)) {
      tableName = "소원표「획득」";
      table = ["원하는 아이템이 있다.", "원하는 생물이 있다.", "원하는 관계가 있다.", "원하는 친족이 있다.", "원하는 지식이 있다.", "원하는 부동산이 있다."];}
      else if (/^CWT$/i['$===']($case) || /^ControlWT$/i['$===']($case)) {
      tableName = "소원표「지배」";
      table = ["지배하고 싶은 인물집단이 있다.", "지배하고 싶은 지역이 있다.", "세계를 정복하고 싶다.", "선거에서 이기고 싶다.", "굴욕을 주고 싶은 사람이 있다.", "어리광쟁이인 친척을 마음대로 하고 싶다."];}
      else if (/^FWT$/i['$===']($case) || /^FlourishWT$/i['$===']($case)) {
      tableName = "소원표「번영」";
      table = ["몰락한 일족을 부흥시키고 싶다.", "지역 경제를 활성화시키고 싶다.", "취미인 장르에서 사람을 모으고 싶다.", "절멸한 생물을 부활시키고 싶다.", "동물이나 식물을 절멸에서 구하고 싶다.", "아무튼 많은 돈을 원한다."];}
      else if (/^IWT$/i['$===']($case) || /^IntensifyWT$/i['$===']($case)) {
      tableName = "소원표「강화」";
      table = ["세계최강이 되고 싶다.", "세계에서 가장 아름다워지고 싶다.", "세계에서 가장 현명해지고 싶다.", "세계에서 가장 행복해지고 싶다.", "세계에서 가장 터프해지고 싶다.", "세계에서 가장 빨라지고 싶다."];}
      else if (/^HWT$/i['$===']($case) || /^HealthWT$/i['$===']($case)) {
      tableName = "소원표「건강」";
      table = ["완성시키고 싶은 약물이 있다.", "절멸시키고 싶은 병원균이 있다.", "난치병에서 회복시키고 싶은 친척이 있다.", "난치병에서 회복하고 싶다.", "병으로 죽은 사람을 부활시키고 싶다.", "병에 걸리지 않는 몸을 원한다."];}
      else if (/^SaWT$/i['$===']($case) || /^SafetyWT$/i['$===']($case)) {
      tableName = "소원표「안전」";
      table = ["평온한 생활을 보내고 싶다.", "평온하게 지내길 바라는 사람이 있다.", "끝내고 싶은 분쟁이 있다.", "사고로 죽은 사람을 부활시키고 싶다.", "사고를 겪지 않는 능력을 원한다.", "다가오는 세계의 위기를 회피하고 싶다."];}
      else if (/^LWT$/i['$===']($case) || /^LongevityWT$/i['$===']($case)) {
      tableName = "소원표「장수」";
      table = ["지금의 아름다움을 유지하고 싶다.", "지금의 강함을 유지하고 싶다.", "아이가 어른이 되기까지 죽지 않는다.", "불로의 몸을 원한다.", "치매에 걸리고 싶지 않다.", "손자의 얼굴을 보고 싶다."];}
      else if (/^EWT$/i['$===']($case) || /^ExistWT$/i['$===']($case)) {
      tableName = "소원표「삶」";
      table = ["살아 있다는 실감을 원한다.", "지금과는 다른 인생을 살고 싶다.", "죽어버렸으니 부활하고 싶다.", "죽은 사람을 되살리고 싶다.", "불사의 몸을 원한다.", "이상의 인생을 손에 넣고 싶다."];};
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      self.$debug("getWishTableResult result", result);
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getWishTableResult_11.$$arity = 1);
    
    Opal.defn(self, '$getNameTableResult', TMP_KillDeathBusiness_Korean_getNameTableResult_12 = function $$getNameTableResult(type) {
      ...
      tableName = "만능이름표";
      nameTable1 = [[11, "아날로그"], [12, "이지"], [13, "이터널"], [14, "일렉트로"], [15, "오토"], [16, "킹"], [22, "쿨"], [23, "그림"], [24, "그레이트"], [25, "슈퍼"], [26, "스푸크"], [33, "스마트"], [34, "드레드"], [35, "하이테크"], [36, "헌터즈"], [44, "블랙"], [45, "헬"], [46, "매직"], [55, "메카니컬"], [56, "러브"], [66, "레드"]];
      nameTable2 = [[11, "X"], [12, "어비스"], [13, "그레이브"], [14, "골드"], [15, "고딕"], [16, "시노비"], [22, "스페셜"], [23, "데몬"], [24, "디지털"], [25, "데스"], [26, "데빌"], [33, "나이트메어"], [34, "발록"], [35, "블러드"], [36, "브레이크"], [44, "블레이즈"], [45, "프로스트"], [46, "메가"], [55, "메카나이즈드"], [56, "림보"], [66, "로보"]];
      nameTable3 = [[11, "암"], [12, "아이"], [13, "이어"], [14, "윙"], [15, "엔진"], [16, "가드"], [22, "건"], [23, "기어"], [24, "캐논"], [25, "서킷"], [26, "스킨"], [33, "소드"], [34, "터빈"], [35, "하트"], [36, "핸드"], [44, "빔"], [45, "플레이트"], [46, "헤어"], [55, "메카니즘"], [56, "모터"], [66, "레그"]];
      result = "";
      number = 0;
      $case = type;
      ...
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getNameTableResult_12.$$arity = 1);
    
    Opal.defn(self, '$getSubprotTableResult', TMP_KillDeathBusiness_Korean_getSubprotTableResult_13 = function $$getSubprotTableResult(command) {
      var $a, $b, self = this, tableName = nil, table = nil, $case = nil, result = nil, number = nil;
      ...
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getSubprotTableResult_13.$$arity = 1);
    
    Opal.defn(self, '$getCmTableResult', TMP_KillDeathBusiness_Korean_getCmTableResult_14 = function $$getCmTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;
      ...
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getCmTableResult_14.$$arity = 0);
    
    Opal.defn(self, '$getErTableResult', TMP_KillDeathBusiness_Korean_getErTableResult_15 = function $$getErTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "소생부작용표";
      table = [[11, "늙다리같은 냄새가 나기 시작한다"], [12, "덤으로 염소가 나왔다"], [13, "머리색이 형광색으로 변했다"], [14, "목소리가 로봇처럼 변했다"], [15, "끝이 삼각형으로 생긴 꼬리가 생겼다"], [16, "얼굴에 수수께끼의 프로그레스 바가 나왔다"], [22, "성별이 바꼇다"], [23, "온몸에 모자이크가 걸렸다"], [24, "전체적으로 반투명이 됬다"], [25, "조금 썩었다"], [26, "피푸가 형광색으로 빛난다"], [33, "날개가 자랐다"], [34, "프로그램 참가중의 기억을 잃었다"], [35, "이마에 제 3의 눈이 열렸다"], [36, "미묘하게 뜬다"], [44, "병아리로 변했다"], [45, "불합격품의 스탬프가 찍혔다"], [46, "살쪗다"], [55, "귀가 좋아하는 동물의 것으로 바꼇다"], [56, "말라졌다"], [66, "훌륭한 뿔이 이마에 났다"]];
      $b = self.$get_table_by_d66_swap(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getErTableResult_15.$$arity = 0);
    
    Opal.defn(self, '$getWKTableResult', TMP_KillDeathBusiness_Korean_getWKTableResult_16 = function $$getWKTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "일주일간표";
      table = [[11, "집에서 쫓겨난 헬P가 묶으러 왔다"], [12, "위험한 오오라를 낼 수 있게 되어, 엄청 인기생겼다"], [13, "지옥입거를 각오하고 신변정리를 했다"], [14, "지옥TV정보잡지에서 인터뷰를 받았다"], [15, "친가의 사업이 잘되고 있는데 손님이 왠지 모두 헬피플"], [16, "신호 기다리고 있는데 업무중인 악마가 사인요청 했다"], [22, "친척이 프로그램을 보고 있고 전화로 감상을 말했다"], [23, "다음 주의 수호천사와 아는 사이가 되버렸다"], [24, "다음 주의 타겟과 아는 사이가 되버렸다"], [25, "트라우마가 남아서 수면을 못하고 술에 빠졌다"], [26, "소원이 이루어지면 일 안해도 되니까,, 일 그만뒀다"], [33, "소원과는 별도로 출연보수가 들어와서 호와롭게 놀았다"], [34, "프로그램 중에 장난으로 사람을 쳤는데, 왠지 죽어버렸다"], [35, "프로그램 중에 악마가 무서워져서 온세상을 도망쳐다녔다"], [36, "팬을 자칭하는 스토커가 집을 망쳐놓았다"], [44, "문득 생각난 김에 산에 들어가서 수련했다"], [45, "헬 스타일리스트한테 집의 의류를 모조리 태워져버렸다"], [46, "헬 닥터가 밀린 치료비를 요구했다"], [55, "헬 드레스의 짝퉁을 강매하려고 한 하급 악마와 싸웠다"], [56, "다른 회수인 중 한명이 같은 직장인이라는 것이 확실해졌다"], [66, "묘하게 기부를 모집하는 영업전화가 걸려오는 주였다"]];
      $b = self.$get_table_by_d66_swap(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getWKTableResult_16.$$arity = 0);
    
    Opal.defn(self, '$getServiceSceneTableResult', TMP_KillDeathBusiness_Korean_getServiceSceneTableResult_17 = function $$getServiceSceneTableResult() {
      ...
      tableName = "서비스 씬 표";
      sceneTable = ["탈의계 서비스 신표", "폭력계 서비스 신표", "여행계 서비스 신표", "연애계 서비스 신표", "감동계 서비스 신표", "다른 장르계 서비스 신표"];
      $b = self.$get_table_by_1d6(sceneTable), $a = Opal.to_ary($b), (sceneGroup = ($a[0] == null ? nil : $a[0])), (number1 = ($a[1] == null ? nil : $a[1])), $b;
      $case = sceneGroup;
      if ("탈의계 서비스 신표"['$===']($case)) {table = ["의장의 문제", "갈아입기", "탈의마작", "입욕", "수영복으로 싸운다", "야구권"]}
      else if ("폭력계 서비스 신표"['$===']($case)) {table = ["이긴 후의 폭력", "집단의 폭력", "폭력을 암시하는 대화", "진 후의 폭력", "전혀 무의미한 폭력", "무의미한 폭력"]}
      else if ("여행계 서비스 신표"['$===']($case)) {table = ["이동기관의 소개", "지역의 놀이를 소개", "지역의 동물을 소개", "지역의 여관을 소개", "일어나면 깜짝이야", "명물 요리의 소개"]}
      else if ("연애계 서비스 신표"['$===']($case)) {table = ["키스신", "사랑을 깨닫다", "사랑에 고민함", "데이트신", "비밀을 고백한다", "러브신"]}
      else if ("감동계 서비스 신표"['$===']($case)) {table = ["가족의 사랑을 깨닫다", "멋진 걸 말한다", "실패해서 실의에 빠진다", "지역 주민과 교류한다", "죽은 사람 얘기를 한다", "높은 곳에서 멋진 걸 말한다"]}
      else {table = ["사이코 서스펜스", "스페이스 오페라", "동화", "히로익 판타지", "몬스터 호러", "로보"]};
      ...
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getServiceSceneTableResult_17.$$arity = 0);
    
    Opal.defn(self, '$getSoulTableResult', TMP_KillDeathBusiness_Korean_getSoulTableResult_18 = function $$getSoulTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;
      ...
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getSoulTableResult_18.$$arity = 0);
    
    Opal.defn(self, '$getSceneTelopGenericTableResult', TMP_KillDeathBusiness_Korean_getSceneTelopGenericTableResult_19 = function $$getSceneTelopGenericTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "범용 연출표";
      table = ["크고 알기 쉬운 자막이 나온다.", "회상에 맞춰 재현 비디오가 흐른다.", "관계자가 등장인물에 대해서 이야기한다.", "게스트 헬 피플이 행동을 논평한다.", "행동의 시비에 대해 헬 시청자의 투표가 시작된다.", "헬 밴드의 신곡이 BGM으로 흐른다."];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getSceneTelopGenericTableResult_19.$$arity = 0);
    
    Opal.defn(self, '$getHairStylistAbuseTableResult', TMP_KillDeathBusiness_Korean_getHairStylistAbuseTableResult_20 = function $$getHairStylistAbuseTableResult(type) {
      ...
      hellStylistAbuseTable1 = [[11, " 땀범벅이 된"], [12, " 영감이 저번에 버린"], [13, " 실패작인"], [14, " 저예산의 영화로 몬스터 대신이 된"], [15, " 무리를 잃은"], [16, " 나쁜 의미로 성분 무조정인"], [22, " 우주인이 내용물을 뺀 후의"], [23, " 화학처리반이 처리하러 올 것 같은"], [24, " 혁명 직후 단두대에 걸린"], [25, " 광기의 예술가가 사상으로 만든"], [26, " 고향 마을을 제국군에게 불태워진 직후의"], [33, " 오년 만에 침대 아래에서 나온"], [34, " 고속도로에서 마구 치인"], [35, " 사후 6주 동안의"], [36, " 실패요리를 억지로 먹인"], [44, " 갓난아기가 처음으로 그린"], [45, " 장롱과 벽 사이의 틈에서 사는"], [46, " 고양이가 물어간"], [55, " 유명한 문어를 닮은 몬스터를 본"], [56, " 여행지에서 지갑이 없단 것을 깨달은"], [66, " 엽기살인을 취미로 하고 있는"]];
      hellStylistAbuseTable2 = [[11, " 아르마딜로"], [12, " 말미잘"], [13, " 노린재"], [14, " 오리너구리"], [15, " 공작"], [16, " 해파리"], [22, " 바퀴벌레"], [23, " 벌레"], [24, " 원숭이"], [25, " 시궁쥐"], [26, " 벌거숭이"], [33, " 해삼"], [34, " 똥"], [35, " 쇠똥구리"], [36, " 펭귄"], [44, " 물벼룩"], [45, " 낡은 인형"], [46, " 식인 곰"], [55, " 독 있는 도마뱀"], [56, " 송충이"], [66, " 들개"]];
      hellStylistwtable1 = ["「마치『", "「마치『", "「정말로『", "「정말로『", "「너는『", "「너는『"];
      hellStylistwtable2 = ["』같아!」", "』같구나!」", "』잖아!」", "』구나.」", "』처럼 보여.」", "』나 다를 바 없어! 」"];
      $case = type;
      ...
      number = "" + (num1) + "," + (num2);};
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getHairStylistAbuseTableResult_20.$$arity = 1);
    
    Opal.defn(self, '$getSkillTableResult', TMP_KillDeathBusiness_Korean_getSkillTableResult_21 = function $$getSkillTableResult(type) {
      ...
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getSkillTableResult_21.$$arity = 1);
    
    Opal.defn(self, '$getExtraTableResult', TMP_KillDeathBusiness_Korean_getExtraTableResult_22 = function $$getExtraTableResult(type) {
      ...
      tableName = "엑스트라 표";
      extraTable1 = [[11, "당신과 친구인"], [12, "당신과 원망하는 녀석의 기회를 노리고 있는"], [13, "바쁘게 전화로 이야기 하고있는"], [14, "넘어지며 도망친"], [15, "씬의 배경의 소유자인"], [16, "가공의 인물이라고 생각되고 있던 신(神)"], [22, "과거의 시즌 우승자인"], [23, "기분 좋게 엄청 취한"], [24, "공포로 몸을 움츠리게 하고 있는"], [25, "업계에서는 유명한"], [26, "행복한 가정을 가지고 있는"], [33, "광역 지명 수배되고 있는"], [34, "오늘 모닝뉴스에서 특집으로 되어 있던"], [35, "항상 미소를 잊지 않는 거물인"], [36, "진실의 탐구 과정에서 발광한"], [44, "현지에서는 패배를 모르는"], [45, "매우 동작에 절도가 있는"], [46, "평범한"], [55, "변신 히어로의 정체인"], [56, "" + "『" + (self.$getNameTableResult(0)['$[]'](1)) + "』의 이명을 가지고 있는"], [66, "역사상의 인물이지만 실은 살아있던"]];
      extraTable2 = [[11, "샐러리맨"], [12, "스포츠 선수"], [13, "양아치"], [14, "드라이버"], [15, "쥐"], [16, "파일럿"], [22, "영화 감독"], [23, "개"], [24, "자객"], [25, "주부"], [26, "소설가"], [33, "작사"], [34, "정치가"], [35, "갑부"], [36, "큰 남자"], [44, "수수께끼의 미녀"], [45, "고양이"], [46, "미소녀"], [55, "문화인"], [56, "용자"], [66, "신(神)"]];
      extraTable3 = [[11, "이상한 상자안에서"], [12, "불쌍한 희생자를 죽이면서"], [13, "소를 타면서"], [14, "말을 타면서"], [15, "벽을 분쇄하면서"], [16, "문을 분쇄하면서"], [22, "진한 안개속에서 천천히"], [23, "자동문에서 나오면서"], [24, "상공에서 급강하하면서"], [25, "전속력으로 달리면서"], [26, "높은 곳으로부터"], [33, "테마 음악과 함께"], [34, "지나가는 길에"], [35, "이름과 직업의 명함과 함께"], [36, "오토바이를 타면서"], [44, "무덤을 뚫으며"], [45, "부하를 여럿 거느리며"], [46, "거친 바람에 감기며"], [55, "무기를 잡으며"], [56, "헬 포탈을 지나며"], [66, "불길을 등에 지며"]];
      extraTable4 = [[11, "사랑스럽게 등장"], [12, "선명하게 등장"], [13, "시원스럽게 등장"], [14, "이상하게 등장"], [15, "몹시 거칠게 등장"], [16, "기세 좋게 등장"], [22, "아름답게 등장"], [23, "잘난듯이 등장"], [24, "엄숙하게 등장"], [25, "무섭게 등장"], [26, "멋지게 등장"], [33, "뽐내며 등장"], [34, "죽음의 예감과 함께 등장"], [35, "조용하게 등장"], [36, "품위있게 등장"], [44, "야무지지 못하게 등장"], [45, "지적이게 등장"], [46, "나고야풍으로 등장"], [55, "매끈하게 등장"], [56, "기분이 안좋게 등장"], [66, "쾌활하게 등장"]];
      $case = type;
      ...
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getExtraTableResult_22.$$arity = 1);
    
    Opal.defn(self, '$getpcTableResult', TMP_KillDeathBusiness_Korean_getpcTableResult_23 = function $$getpcTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "제작위원 결정표";
      table = [[11, "헬 라이온"], [12, "헬 라이온"], [13, "헬 라이온"], [14, "헬 크로우"], [15, "헬 크로우"], [16, "헬 크로우"], [22, "헬 스네이크"], [23, "헬 스네이크"], [24, "헬 스네이크"], [25, "헬 드래곤"], [26, "헬 드래곤"], [33, "헬 드래곤"], [34, "헬 플라이"], [35, "헬 플라이"], [36, "헬 플라이"], [44, "헬 갓"], [45, "헬 갓"], [46, "헬 갓"], [55, "헬 베어"], [56, "헬 베어"], [66, "헬 베어"]];
      $b = self.$get_table_by_d66_swap(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getpcTableResult_23.$$arity = 0);
    
    Opal.defn(self, '$getohTableResult', TMP_KillDeathBusiness_Korean_getohTableResult_24 = function $$getohTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "실제로 어떠했는가 표";
      table = ["대개【흥행수입】의 예측은 정확했다. 증감은 없이, 회수인은 당분간 공공장소에서 인기였다.", "생각보다 흥행했다!【흥행수입】이 4D6억 헬엔 증가. 장르의 수작으로 5년 후에도 가끔 입에 오른다", "조금 트러블이 생겨서 공개 시기를 놓쳤다. 【흥행수입】이 4D6억 헬엔 감소. 헬-레이의 매상을 기대하자", "이런 맙소사, 동시기에 타시즌의 영화판이 공개된다. 【흥행수입】이 반이 된다.", "오 맙소사, 헬 아카데미상을 잔뜩 받았다.【흥행수입】이 두배가 된다!", "에피소드의 표현중에 미묘하고 귀찮은 문제를 일으켜 많은 헬 피플이 언짢게 본다. 공개는 없음으로."];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getohTableResult_24.$$arity = 0);
    
    Opal.defn(self, '$getplTableResult', TMP_KillDeathBusiness_Korean_getplTableResult_25 = function $$getplTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;
    ...
    Opal.defn(self, '$getprTableResult', TMP_KillDeathBusiness_Korean_getprTableResult_26 = function $$getprTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "헬 크로우터스크 표";
      table = ["「초라한 게스트.」지정 특기는《악당》. 일반인이나 개, 남동생이나 엄마가 게스트로서 등장한다. 본래의 게스트와의 차액은 착복된다. 사정을 알려져 있지 않은 게스트와 잘 관련되자!", "「친가에서의 촬영.」지정 특기는《외치다》. 촬영 장소가 친가가 된다. 본래의 로케 비용은 착복된다. 가족을 설득하고, 잘 촬영 허가를 받지 않으면 적자가 나와 버릴 것이다!", "「평상복으로의 촬영.」지정 특기는《안경》. 왠지 헬 스타일리스트가 휴일로, 그 만큼의 인건비와 의상대로써 착복된다. 평상복인 채로 초상의 액션을 해내는 것은 불가능하게 가깝다!", "「도보로 이동한다.」지정 특기는《고딕》. 헬 포털의 예산이 착복되었다. 오로지 씬까지 걷지 않으면 촬영조차 할 수 없다. 촬영전에 녹초가되어 버리면, 관객에게도 전해질 것이다.", "「특수 효과가 나오지 않는다.」지정 특기는《기대》. 리얼타임 특수 효과의 예산이 착복되었다! 예산 없이 일하려고 하지 않는 헬 SFX 엔지니어를, 어떻게든 애원이라도 해서 일하게 하자!", "「식사가 나오지 않는다.」지정 특기는《획득》. 식사의 시간이지만, 헬 주문 도시락이 오지 않는다. 그 만큼의 예산이 착복되었던 것이다. 공복인 상태로 좋은 연기를 하려면 , 기합에 의지할 수 밖에 없다."];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getprTableResult_26.$$arity = 0);
    
    Opal.defn(self, '$getpnTableResult', TMP_KillDeathBusiness_Korean_getpnTableResult_27 = function $$getpnTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "헬 스네이크터스크 표";
      table = ["「원수.」지정 특기는《가사도우미》. 과거 개변에 의해, 임의의 상대가, 갑자기 부모의 원수나 연인의 원수가 된다. 당황하지 않고 분노에 불타자. 왜 이렇게 되었는지, 생각해선 안돼!", "「사소한 일로부터 대싸움.」지정 특기는《기다리다》. 임의의 상대와 아무래도 좋은 이유로 싸움을 하는 것을 강요 당한다. 정말로 아무래도 좋아지고 싸움을 그만두는 것은 용서되지 않는다.", "「이익이 상반된다.」지정 특기는《네크리스》. 임의의 상대가 바라는 것과 자신이 바라는 것이 양립하지 않는 것을 어필 당한다. 그렇지 않더라 하여도 억지로 이유를 생각해 내라!", "「신적.」지정 특기는《네이키드》. 취미나 종교를 이유로, 임의의 상대와 싸움 하는 것을 강요 당한다. 이야기하고 알아 버리거나 취미의 폭이 넓어져선 안 된다.", "「유아기의 트라우마.」지정 특기는《질투》. 과거 개변으로 슬픈 기억이 날조 되어 엽기 살인범으로서 캐릭터가 추가된다. 약간 깬다거나 슬퍼하지마라. 미쳐라!", "「인류 일반상식의 미움.」지정 특기는《복수》. 이유 없게 사람을 미워하는 것을 강요 당한다. 원래 성격 좋은 회수인에 있어서는 상당한 난행이다. 인류의 나쁜 면 찾기를 하자!"];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getpnTableResult_27.$$arity = 0);
    
    Opal.defn(self, '$getpdTableResult', TMP_KillDeathBusiness_Korean_getpdTableResult_28 = function $$getpdTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "헬 드래곤터스크 표";
      table = [" 「바리에이션을 보고 싶어서 NG.」지정 특기는《대물》. 별로 나쁜 연기는 아닌데, 조금 다른 바리에이션을 몇번이나 할거야. 이성을 잃지 말고 참아 줘!", "「뭔가 다르니까 NG.」지정 특기는《때리다》. 회수인의 연기에 트집을 잡을 수 있었다. 그러나 어떤 연기를 하면 좋은 것인지 가르쳐 주지 않는다. 이성을 잃지 않고 참아 줘! 다른 사람을 때려라!", "「 아직 시간이 있으니까 NG.」지정 특기는《타투》. 바보같은 이유로 NG가 나왔지만, 어쨌든 이성을 잃지 않고 참아 줘. 헬 드래곤의 기분을 해친다면 광고비가 깎아진다!", "「예산을 다 사용하고 싶어서 NG.」지정 특기는《네이키드》. 아직 인건비를 사용할 수 있기 때문에 다시 한번, 이라든가 하는 이유로 재시도다. 이성을 잃지 않고 참아 줘. 녀석은 돈을 가지고 있어!", "「기분이 나쁘기 때문에 NG.」지정 특기는《화내다》. 집에서 무엇인가 싫은 일이 있었으므로 라는 둥 트집을 잡혔다. 이제, 무엇을 해도 OK는 나오지 않는다. 이성을 잃지 않고 참아 줘. 언젠가는 끝난다!", "「네 존재자체가 NG.」지정 특기는《안전》. 회수인의 인선 그 자체에 트집을 잡을 수 있었다. 당신에게 NG를 내는 것만이 목적이다. 이성을 잃지 않고 참아 줘. 상대는 무진장 강하다."];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getpdTableResult_28.$$arity = 0);
    
    Opal.defn(self, '$getpfTableResult', TMP_KillDeathBusiness_Korean_getpfTableResult_29 = function $$getpfTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "헬 플라잉터스크 표";
      table = ["「더러운 화장실.」지정 특기는《탐정》. 몹시 비위생적인 장소로 배경이 변경된다. 똥투성이 푸세식인 화장실인지, 똥구덩이 냄새가 풀풀난다. 악취에 견딜 수 있을지, 그것이 승부의 갈림길이다!", "「예술적 음부 은폐.」지정 특기는《뛰다》. 전라로 씬을 내지만 비쳐선 안 되는 것 이다. 본래라면 수영복의 천이 있는 부분이 카메라에 비치지 않게, 장애물을 활용해라!", "「촉수.」지정 특기는《벨트》. 당돌하게 촉수 몬스터가 등장한다. 그는 신사적이지만 가차 없이 습격해오므로, 섹시하게 져라! 아니면 관객은 실망할 것이다!", "「미끌미끌.」지정 특기는《트레드》. 어쩐지 점액이 들어간 물통이 등장한다. 이것을 감싸고 씬을 시작하라고 말한다. 성분도 모르는 점액은 싫지만, 어떻게든 참아라!", "「병원체를 거쳐 입으로 섭취한다.」지정 특기는《공포》. 병의 원인이 될 것 같은 것을 억지로 먹혀진다. 구체적으로는 배설물이나 부패한 것, 처음부터 비위생적인 것 이다.", "「국부에의 심한 타격.」지정 특기는《죽음》. 헬 AD나 다른 캐릭터로부터 국부가 강타되는 것을 강요 당한다. 죽지 않고 잘 아파해라. 잘못하면 쇼크로 그대로 죽는다!"];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getpfTableResult_29.$$arity = 0);
    
    Opal.defn(self, '$getpgTableResult', TMP_KillDeathBusiness_Korean_getpgTableResult_30 = function $$getpgTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "헬 갓터스크 표";
      table = ["「아이돌이 동료로서 등장.」지정 특기는《의사》. 푸시받는 아이돌이 회수인의 아군으로서 등장하므로, 부드럽게 관계를 쌓아 올려 공투 해, 상대를 세우자. 리스펙트다!", "「아이돌이 적으로서 등장.」지정 특기는《차다》. 푸시받는 아이돌이 표적의 아군. 회수인의 적으로서 등장! 볼만한 장면을 준비 해 주면서, 잘 넘어뜨려라. 일방적으로는 안돼!", "「아이돌이 무의미하게 등장.」지정 특기는《검》. 푸시받는 아이돌이 등장하지만, 왜 등장하는지 아무도 모른다. 본인도 대본을 받지 않았다. 즉흥으로 어떻게든 해라!", "「아이돌의 동료가 된다.」지정 특기는《에스닉》. 푸시받는 아이돌의 동료가 되어, 당돌하게 사랑이나 모험을 한다. 황금의 영혼과 관계없는 이야기가 계속 되지만, 관객에게 그것을 눈치채게 하지 말아라!", "「아이돌과 악수.」지정 특기는《사랑》. 푸시받는 아이돌이 갑자기 나와 악수해 준다. 갑작스러운 일이지만, 당황해선 안 된다. 흐르는 듯이 화제를 만들며 회화해, 악수에 대해 코멘트를 하자!", "「같이 댄스.」지정 특기는《건강》. 갑자기 댄스 씬이 시작된다! 다만 회수인은 백 댄서다. 노래해라! 다 춤추어라! 헐떡거리거나 웃는 얼굴이 망가지면 NG다!"];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getpgTableResult_30.$$arity = 0);
    return (Opal.defn(self, '$getpbTableResult', TMP_KillDeathBusiness_Korean_getpbTableResult_31 = function $$getpbTableResult() {
      var $a, $b, self = this, tableName = nil, table = nil, result = nil, number = nil;

      
      tableName = "헬 베어터스크 표";
      table = ["「헬 이불.」지정 특기는《대물》. 지옥과 같은 잘 때의 기분을 제공하는, 한 장 200만 헬엔의 헬 이불을 어필하는 것에. 소재는 절대 그렇게 좋지 않기 때문에, 기술을 강조하자.", "「헬 핸드백.」지정 특기는《잡다》. 무한하게 물건이 들어가는 핸드백을 어필이다. 다만 원하는 것을 꺼낼 수 없고, 가방안에 가방을 넣으면, 심한 일이 일어난다.", "「헬 마스크.」지정 특기는《모자》. 완전하게 헬 P의 머리 부분을 재현한 고급 마스크를 써, 그 훌륭함을 어필하면서 영화를 촬영하자. 덧붙여 시야는 몹시 나쁘다.", "「헬 카메라.」지정 특기는《아이돌》. 반드시 심령 사진이 찍히는 카메라를 사용하며 손님에게 강매해라! 영령사진이 나오기도 하지만, 그것을 눈치채여선 안 된다. 사진을 분명히 잘 보인다!", "「헬 와치.」지정 특기는《초조》. 시간은 모르지만 엄청 멋진 시계를 어필. 그 거 팔찌아냐, 라고 태클받기기 전에 잘 회유하자!", "「헬 부적.」지정 특기는《번영》. 소원을 성취하는 악령이, 당신의 성공을 확약! 그 다음은 성공한 채로 사고로 죽게 되지만, 그런 것 사소한 일이다!"];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      return [tableName, result, number];
    }, TMP_KillDeathBusiness_Korean_getpbTableResult_31.$$arity = 0), nil) && 'getpbTableResult';
