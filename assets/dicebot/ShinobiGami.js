...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$==', '$<=', '$>=', '$upcase', '$roll_tables', '$===', '$sinobigami_random_skill_table', '$sinobigami_metamorphose_table', '$private', '$get_table_by_1d6', '$get_table_by_2d6', '$[]', '$-', '$+', '$freeze', '$new', '$setPrefixes', '$keys']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'NAME', "シノビガミ");
    Opal.const_set($nesting[0], 'SORT_KEY', "しのひかみ");
    ...
    Opal.def(self, '$initialize', $ShinobiGami_initialize$1 = function $$initialize() {
      var $iter = $ShinobiGami_initialize$1.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $ShinobiGami_initialize$1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      
      $send(self, Opal.find_super_dispatcher(self, 'initialize', $ShinobiGami_initialize$1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 2);
    }, $ShinobiGami_initialize$1.$$arity = 0);
    
    Opal.def(self, '$check_2D6', $ShinobiGami_check_2D6$2 = function $$check_2D6(total, dice_total, _dice_list, cmp_op, target) {
      var self = this;
    ...
    }, $ShinobiGami_check_2D6$2.$$arity = 5);
    
    Opal.def(self, '$rollDiceCommand', $ShinobiGami_rollDiceCommand$3 = function $$rollDiceCommand(command) {
      var self = this, string = nil, result = nil, $case = nil;
      ...
      if ($truthy(result)) {
        return result};
      $case = string;
      if (/\w*RTT/['$===']($case)) {return self.$sinobigami_random_skill_table()}
      else if ("MT"['$===']($case)) {return self.$sinobigami_metamorphose_table()};
      return nil;
