...
Opal.modules["diceBot/GardenOrder"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$gameName', TMP_GardenOrder_gameName_1 = function $$gameName() {
      ...
      return "ガーデンオーダー"
    }, TMP_GardenOrder_gameName_1.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_GardenOrder_gameType_2 = function $$gameType() {
      var self = this;

      return "GardenOrder"
    }, TMP_GardenOrder_gameType_2.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_GardenOrder_getHelpMessage_3 = function $$getHelpMessage() {
      var self = this;
    ...
    Opal.defn(self, '$get_critical_border', TMP_GardenOrder_get_critical_border_5 = function $$get_critical_border(critical_border_text, success_rate) {
    ...
    }, TMP_GardenOrder_get_critical_border_5.$$arity = 2);
    
    Opal.defn(self, '$check_roll_repeat_attack', TMP_GardenOrder_check_roll_repeat_attack_6 = function $$check_roll_repeat_attack(success_rate, repeat_count, critical_border) {
    ...
    }, TMP_GardenOrder_check_roll_repeat_attack_6.$$arity = 3);
    
    Opal.defn(self, '$check_roll', TMP_GardenOrder_check_roll_7 = function $$check_roll(success_rate, critical_border) {
      ...
      return text;
    }, TMP_GardenOrder_check_roll_7.$$arity = 2);
    
    Opal.defn(self, '$get_check_result', TMP_GardenOrder_get_check_result_8 = function $$get_check_result(dice_value, success_rate, critical_border, fumble_border) {
      var self = this;
      ...
      if ($truthy($rb_le(dice_value, success_rate))) {
        return "成功"};
      return "失敗";
    }, TMP_GardenOrder_get_check_result_8.$$arity = 4);
    
    Opal.defn(self, '$look_up_damage_chart', TMP_GardenOrder_look_up_damage_chart_9 = function $$look_up_damage_chart(type, damage_value) {
...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    function $AceKillerGene(){};
    var self = $AceKillerGene = $klass($base, $super, 'AceKillerGene', $AceKillerGene);
    ...
    Opal.defn(self, '$gameName', TMP_AceKillerGene_gameName_1 = function $$gameName() {
      ...
      return "エースキラージーン"
    }, TMP_AceKillerGene_gameName_1.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_AceKillerGene_gameType_2 = function $$gameType() {
      var self = this;

      return "AceKillerGene"
    }, TMP_AceKillerGene_gameType_2.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_AceKillerGene_getHelpMessage_3 = function $$getHelpMessage() {
      var self = this;

      return "" + "・基本判定\n" + "　AKx/y@z　x：成功率、y：連続攻撃回数（省略可）、z：クリティカル値（省略可）\n" + "　（連続攻撃では1回の判定のみが実施されます）\n" + "　例）AK55　AK100/2　AK70@10　AK155/3@44\n" + "・負傷表\n" + "　DCxxy\n" + "　xx：属性（切断：SL，銃弾：BL，衝撃：IM，灼熱：BR，冷却：RF，電撃：EL）\n" + "　y：ダメージ\n" + "　例）DCSL7　DCEL22\n"
    }, TMP_AceKillerGene_getHelpMessage_3.$$arity = 0);
    return (Opal.defn(self, '$rollDiceCommand', TMP_AceKillerGene_rollDiceCommand_4 = function $$rollDiceCommand(command) {
      var $a, self = this, $case = nil, success_rate = nil, repeat_count = nil, critical_border_text = nil, critical_border = nil, type = nil, damage_value = nil;
      ...
      return self.$look_up_damage_chart(type, damage_value);};
      return nil;
    }, TMP_AceKillerGene_rollDiceCommand_4.$$arity = 1), nil) && 'rollDiceCommand';
  })($nesting[0], Opal.const_get_relative($nesting, 'GardenOrder'), $nesting);
})(Opal);
